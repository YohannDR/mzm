...
source: BufferedReader = open("../src/data/tourian_escape_data.c", "r")
...
def Func():
    ...
    while line != '':
        ...
        if line.find("OAM_DATA_SIZE") != -1:
            splitted = line.split("const u16 sTourianEscape_")

            addr: int = int(splitted[1].split("[")[0], 16)

...
header: BufferedReader = open("../include/data/rooms/chozodia_rooms_data.h", "r")
...
def Func():
    ...
    cFileName: str = "Chozodia_" + str(currentRoom) + ".c"

    if os.path.exists(cFileName):
        os.remove(cFileName)

    f = open(cFileName, "w")
    f.write('#include "data/rooms/chozodia_rooms_data.h"\n#include "macros.h"\n\n')
    ...
    while line != '':
        ...
        if currentRoom != actualRoom:
            ...
            if not prevIsScroll:
                ...
                cFileName = "Chozodia_" + str(currentRoom) + ".c"

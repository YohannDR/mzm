...
#define OPTIONS_OAM_ID_SOUND_TEST_LEFT_ARROW_MOVING 8
#define OPTIONS_OAM_ID_SOUND_TEST_LEFT_ARROW_IDLE 9
#define OPTIONS_OAM_ID_SOUND_TEST_RIGHT_ARROW_MOVING 10
#define OPTIONS_OAM_ID_SOUND_TEST_RIGHT_ARROW_IDLE 11

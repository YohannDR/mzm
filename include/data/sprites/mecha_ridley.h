...
extern const struct FrameData sMechaRidleyMultiSpriteData_CrawlingForwardMiddle[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_CrawlingForwardHigh[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_Crawling_Unused1[2];

extern const struct FrameData sMechaRidleyMultiSpriteData_Crawling_Unused2[2];

extern const struct FrameData sMechaRidleyMultiSpriteData_Crawling_Unused3[2];

extern const struct FrameData sMechaRidleyMultiSpriteData_DyingStandingLow[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_DyingStandingMiddle[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_DyingStandingHigh[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_RaisingArmLow[4];

extern const struct FrameData sMechaRidleyMultiSpriteData_RaisingArmMiddle[4];

extern const struct FrameData sMechaRidleyMultiSpriteData_RaisingArmHigh[4];

extern const struct FrameData sMechaRidleyMultiSpriteData_StandingLow[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_StandingMiddle[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_StandingHigh[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_SmallSwipeLow[6];

extern const struct FrameData sMechaRidleyMultiSpriteData_SmallSwipeMiddle[6];

extern const struct FrameData sMechaRidleyMultiSpriteData_SmallSwipeHigh[6];

extern const struct FrameData sMechaRidleyMultiSpriteData_ShakingHeadLow[10];

extern const struct FrameData sMechaRidleyMultiSpriteData_ShakingHeadMiddle[10];

extern const struct FrameData sMechaRidleyMultiSpriteData_ShakingHeadHigh[10];

extern const struct FrameData sMechaRidleyMultiSpriteData_LowToMiddle[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_MiddleToHigh[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_HighToMiddle[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_MiddleToLow[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_LowToHigh[5];

extern const struct FrameData sMechaRidleyMultiSpriteData_HighToLow[5];

extern const struct FrameData sMechaRidleyMultiSpriteData_OpeningMouthLow[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_SpittingFireballsLow[4];

extern const struct FrameData sMechaRidleyMultiSpriteData_ClosingMouthLow[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_OpeningMouthMiddle[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_SpittingFireballsMiddle[4];

extern const struct FrameData sMechaRidleyMultiSpriteData_ClosingMouthMiddle[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_OpeningMouthHigh[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_SpittingFireballsHigh[4];

extern const struct FrameData sMechaRidleyMultiSpriteData_ClosingMouthHigh[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_FiringMissilesArmsUpLow[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_FiringMissilesArmsUpMiddle[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_FiringMissilesArmsUpHigh[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_FiringMissilesLow[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_FiringMissilesMiddle[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_FiringMissilesHigh[3];

extern const struct FrameData sMechaRidleyMultiSpriteData_Dying[11];

extern const struct FrameData sMechaRidleyMultiSpriteData_CrawlingBackwardsLow[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_CrawlingBackwardsMiddle[7];

extern const struct FrameData sMechaRidleyMultiSpriteData_CrawlingBackwardsHigh[7];

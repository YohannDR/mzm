...
extern const struct FrameData sKraidMultiSpriteData_Standing[4];

extern const struct FrameData sKraidMultiSpriteData_StandingBetweenSteps[4];

extern const struct FrameData sKraidMultiSpriteData_MovingLeftFeetToRight[7];

extern const struct FrameData sKraidMultiSpriteData_MovingRightFeetToRight[7];

extern const struct FrameData sKraidMultiSpriteData_MovingLeftFeetToLeft[7];

extern const struct FrameData sKraidMultiSpriteData_MovingRightFeetToLeft[7];

extern const struct FrameData sKraidMultiSpriteData_Dying1[2];

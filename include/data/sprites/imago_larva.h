...
extern const struct FrameData sImagoLarvaMultiSpriteData_Idle[5];

extern const struct FrameData sImagoLarvaMultiSpriteData_Retreating[12];

extern const struct FrameData sImagoLarvaMultiSpriteData_Dying[9];

extern const struct FrameData sImagoLarvaMultiSpriteData_Warning[10];

extern const struct FrameData sImagoLarvaMultiSpriteData_TakingDamage[5] ;

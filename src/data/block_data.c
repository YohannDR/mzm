...
const u16 sReformingBlocksTilemapValue[MAX_AMOUNT_OF_BLOCKS_TYPES] = {
    [BLOCK_TYPE_NONE] =                         CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_AIR,
    [BLOCK_TYPE_SHOT_BLOCK_REFORM] =            CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SHOT_BLOCK_REFORM,
    [BLOCK_TYPE_BOMB_BLOCK_REFORM] =            CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_BOMB_BLOCK_REFORM,
    [BLOCK_TYPE_SPEEDBOOSTER_BLOCK_REFORM] =    CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SPEEDBOOST_REFORM,
    [BLOCK_TYPE_CRUMBLE] =                      CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_CRUMBLE,
    [BLOCK_TYPE_SLOW_CRUMBLE] =                 CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SLOW_CRUMBLE,
    [BLOCK_TYPE_MISSILE_NEVER_REFORM] =         CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_MISSILE_NEVER_REFORM,
    [BLOCK_TYPE_MISSILE_NO_REFORM] =            CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_MISSILE_NO_REFORM,
    [BLOCK_TYPE_SUPER_MISSILE_NEVER_REFORM] =   CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SUPER_MISSILE_NEVER_REFORM,
    [BLOCK_TYPE_SUPER_MISSILE_NO_REFORM] =      CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SUPER_MISSILE_NO_REFORM,
    [BLOCK_TYPE_POWER_BOMB_NEVER_REFORM] =      CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_POWER_BOMB_NEVER_REFORM,
    [BLOCK_TYPE_SCREW_NO_REFORM] =              CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SCREW_ATTACK_NO_REFORM,
    [BLOCK_TYPE_SPEEDBOOSTER_BLOCK_NO_REFORM] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SPEEDBOOST_NO_REFORM,
    [BLOCK_TYPE_BOMB_BLOCK_NEVER_REFORM] =      CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_BOMB_NEVER_REFORM,
    [BLOCK_TYPE_VERTICAL_BOMB_CHAIN1] =         CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_VERTICAL_BOMB_CHAIN1,
    [BLOCK_TYPE_VERTICAL_BOMB_CHAIN2] =         CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_VERTICAL_BOMB_CHAIN2,
    [BLOCK_TYPE_VERTICAL_BOMB_CHAIN3] =         CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_VERTICAL_BOMB_CHAIN3,
    [BLOCK_TYPE_VERTICAL_BOMB_CHAIN4] =         CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_VERTICAL_BOMB_CHAIN4,
    [BLOCK_TYPE_HORIZONTAL_BOMB_CHAIN1] =       CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_HORIZONTAL_BOMB_CHAIN1,
    [BLOCK_TYPE_HORIZONTAL_BOMB_CHAIN2] =       CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_HORIZONTAL_BOMB_CHAIN2,
    [BLOCK_TYPE_HORIZONTAL_BOMB_CHAIN3] =       CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_HORIZONTAL_BOMB_CHAIN3,
    [BLOCK_TYPE_HORIZONTAL_BOMB_CHAIN4] =       CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_HORIZONTAL_BOMB_CHAIN4
};
...
const struct TankBehavior sTankBehaviors[MAX_AMOUNT_OF_TANK_TYPES] = {
    [BEHAVIOR_TO_TANK(CLIP_BEHAVIOR_HIDDEN_ENERGY_TANK)] = {
        ...
        .revealedClipdata = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_ENERGY_TANK
    },
    [BEHAVIOR_TO_TANK(CLIP_BEHAVIOR_HIDDEN_MISSILE_TANK)] = {
        .itemType = ITEM_TYPE_NONE,
        .underwater = FALSE,
        .messageID = MESSAGE_NONE,
        .revealedClipdata = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_MISSILE_TANK
    },
    [BEHAVIOR_TO_TANK(CLIP_BEHAVIOR_HIDDEN_SUPER_MISSILE_TANK)] = {
        .itemType = ITEM_TYPE_NONE,
        .underwater = FALSE,
        .messageID = MESSAGE_NONE,
        .revealedClipdata = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SUPER_MISSILE_TANK
    },
    [BEHAVIOR_TO_TANK(CLIP_BEHAVIOR_HIDDEN_POWER_BOMB_TANK)] = {
        .itemType = ITEM_TYPE_NONE,
        .underwater = FALSE,
        .messageID = MESSAGE_NONE,
        .revealedClipdata = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_POWER_BOMB_TANK
    },

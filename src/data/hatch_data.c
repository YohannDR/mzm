...
const u16 sHatchesTilemapValues[MAX_AMOUNT_OF_HATCH_TYPES] = {
    [HATCH_NONE] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_NO_HATCH,
    [HATCH_UNUSED] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_GRAY_DOOR,
    [HATCH_NORMAL] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_REGULAR_DOOR,
    [HATCH_MISSILE] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_MISSILE_DOOR,
    [HATCH_SUPER_MISSILE] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_SUPER_MISSILE_DOOR,
    [HATCH_POWER_BOMB] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_POWER_BOMB_DOOR,
    [HATCH_LOCKED] = CLIPDATA_CUSTOM_FLAG | CLIPDATA_CUSTOM_GRAY_DOOR,
    [HATCH_LOCKED_AND_LOCK_DESTINATION] = CLIPDATA_CUSTOM_FLAG | 0x1A
};

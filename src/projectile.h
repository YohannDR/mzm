...
void projectile_missile_hit_sprite(struct sprite_data* ptr, u16 y_position, u16 x_position, u16 damage);
void projectile_super_missile_hit_sprite(struct sprite_data* ptr, u16 y_position, u16 x_position, u16 damage);

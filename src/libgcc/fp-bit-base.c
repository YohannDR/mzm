...
FLO_type pack_d ( fp_number_type *  src);
void unpack_d (FLO_union_type * src, fp_number_type * dst);
...
extern SFtype __make_fp (fp_class_type, unsigned int, int, USItype frac);

...
lbl_0800c6c0:
    bl sub_0800d4bc
    bl ProjectileDrawAllStatusTrue
    bl ResetFreeOAM
    bl update_room_info
...
lbl_0800cbf2:
    bl ClearGFXRAM
    bl HUDGenericLoadCommonSpriteGFX
lbl_0800cbfa:
...
SpriteSpawnSecondary: @ 0x0800e258
    push {r4, r5, r6, r7, lr}
    mov r7, sl
    mov r6, sb
    mov r5, r8

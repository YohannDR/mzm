...
lbl_080610e0:
    ldr r0, lbl_08061140 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrh r0, [r1, #2]
    adds r0, #1
    strh r0, [r1, #2]
...
lbl_08061136:
    ...
    b lbl_0806121c
    .align 2, 0
lbl_08061140: .4byte sNonGameplayRamPointer
...
lbl_08061158:
    ldr r0, lbl_0806117c @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r0, #0xbf
    ldrb r0, [r0]
    cmp r0, #3
    ...
    b lbl_08061198
    .align 2, 0
lbl_0806117c: .4byte sNonGameplayRamPointer
...
sub_0806122c: @ 0x0806122c
    ...
    ldr r0, [r1, #8]
    subs r1, #0xc4
    ldr r0, lbl_080612bc @ =sNonGameplayRamPointer
    ldr r2, [r0]
    ldrh r0, [r2, #0x30]
    strh r0, [r1]
    adds r1, #2
...
lbl_080612bc: .4byte sNonGameplayRamPointer
...
lbl_080613d8: .4byte sNonGameplayRamPointer
...
lbl_0806144a:
    ...
    movs r1, #3
lbl_08061454:
    ldr r0, lbl_08061480 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    lsls r0, r1, #1
    adds r2, #0x20
    adds r2, r2, r0
...
lbl_08061478:
    ...
    bx r0
    .align 2, 0
lbl_08061480: .4byte sNonGameplayRamPointer
...
lbl_080614b4:
    ...
    movs r1, #3
lbl_080614be:
    ldr r0, lbl_080614d0 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    lsls r1, r1, #1
    adds r0, #0x20
    adds r0, r0, r1
...
lbl_080614ca:
    ...
    bx r0
    .align 2, 0
lbl_080614d0: .4byte sNonGameplayRamPointer
...
CutsceneStartBackgroundScrolling: @ 0x08061618
    ...
    cmp r0, #0
    beq lbl_0806164e
    ldr r0, lbl_080616d0 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    lsls r0, r5, #0x18
    lsrs r0, r0, #0x18
    lsls r1, r0, #1
...
lbl_080616c6:
    ...
    b lbl_080618ce
    .align 2, 0
lbl_080616d0: .4byte sNonGameplayRamPointer
lbl_080616d4:
    cmp r7, #1
    beq lbl_080616fc
    cmp r7, #1
...
lbl_08061744:
    ...
    lsrs r0, r0, #0x18
    adds r3, r3, r0
    ldr r2, lbl_08061760 @ =sNonGameplayRamPointer
    mov r8, r2
    cmp r3, #7
    bls lbl_08061754
    b lbl_08061860
lbl_08061754:
    ...
    mov pc, r0
    .align 2, 0
lbl_08061760: .4byte sNonGameplayRamPointer
...
lbl_08061788:
    ldr r2, lbl_0806179c @ =sNonGameplayRamPointer
    ldr r1, [r2]
    lsls r0, r3, #1
    adds r0, r0, r3
    lsls r0, r0, #2
...
lbl_08061980:
    ...
    blt lbl_080619b8
lbl_08061984:
    ldr r0, lbl_080619c0 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    lsls r0, r2, #1
    adds r0, r0, r2
    lsls r0, r0, #2
...
lbl_080619b8:
    ...
    bx r1
    .align 2, 0
lbl_080619c0: .4byte sNonGameplayRamPointer
...
CutsceneUpdateBackgroundsPosition: @ 0x080619c4
    ...
    movs r4, #7
lbl_080619d8:
    ldr r0, lbl_08061a64 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    adds r0, r1, #0
    adds r0, #0x38
    adds r0, r0, r5
...
lbl_08061ab6:
    ...
    cmp r0, #0
    beq lbl_08061ae4
    ldr r0, lbl_08061b30 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrh r0, [r1, #0x30]
    adds r0, r0, r3
    strh r0, [r1, #0x30]
...
lbl_08061b30: .4byte sNonGameplayRamPointer
lbl_08061b34:
    ldrh r1, [r2]
    movs r0, #0x80
    lsls r0, r0, #1
    ...
    cmp r0, #0
    beq lbl_08061b4a
    ldr r0, lbl_08061b94 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrh r0, [r1, #0x28]
    adds r0, r0, r3
    strh r0, [r1, #0x28]
...
lbl_08061b8c:
    ...
    bx r0
    .align 2, 0
lbl_08061b94: .4byte sNonGameplayRamPointer
...
CutsceneStartScreenShake: @ 0x08061b98
    ...
    cmp r0, #0
    bne lbl_08061bbc
    ldr r0, lbl_08061bb8 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r2, r0, #0
    adds r2, #0x98
    movs r1, #0
    ...
    b lbl_08061bcc
    .align 2, 0
lbl_08061bb8: .4byte sNonGameplayRamPointer
lbl_08061bbc:
    cmp r0, #1
    bne lbl_08061bd8
    ldr r0, lbl_08061be0 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r2, r0, #0
    adds r2, #0xa0
    movs r1, #0
...
lbl_08061bd8:
    ...
    bx r0
    .align 2, 0
lbl_08061be0: .4byte sNonGameplayRamPointer

    thumb_func_start sub_08061be4
sub_08061be4: @ 0x08061be4
    push {r4, r5, r6, r7, lr}
    ldr r1, lbl_08061c18 @ =sNonGameplayRamPointer
    ldr r2, [r1]
    adds r0, r2, #0
    adds r0, #0xa8
    ldrb r3, [r0]
...
lbl_08061bfc:
    ...
    b lbl_08061d60
    .align 2, 0
lbl_08061c18: .4byte sNonGameplayRamPointer
lbl_08061c1c:
    adds r0, r2, #0
    adds r0, #0xaf
    ldrb r0, [r0]
...
CutsceneReset: @ 0x08061e38
    ...
    strh r2, [r0]
    ldr r1, lbl_08061efc @ =sNonGameplayRamPointer
    ldr r0, [r1]
    adds r0, #0xa8
    movs r3, #0
    strb r2, [r0]
...
lbl_08061efc: .4byte sNonGameplayRamPointer
...
unk_61f0c: @ 0x08061f0c
    ldr r0, lbl_08061f20 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    movs r0, #0
    strh r0, [r2, #0x1c]
...
unk_61f28: @ 0x08061f28
    ...
    bx lr
    .align 2, 0
lbl_08061f3c: .4byte sNonGameplayRamPointer
...
sub_08061f60: @ 0x08061f60
    push {r4, lr}
    sub sp, #4
    ldr r4, lbl_08061f98 @ =sNonGameplayRamPointer
    ldr r0, [r4]
    adds r0, #0xbc
    ldrb r0, [r0]
    cmp r0, #0
...
CutsceneStartBackgroundFading: @ 0x08061fa0
    ...
    lsrs r4, r4, #0x18
    movs r7, #0
    ldr r1, lbl_08061fe8 @ =sNonGameplayRamPointer
    ldr r0, [r1]
    adds r0, #0xbb
    strb r7, [r0]
    ldr r0, [r1]
...
lbl_08062108:
    ...
    bl FadeMusic
lbl_0806210e:
    ldr r1, lbl_08062130 @ =sNonGameplayRamPointer
    ldr r0, [r1]
    adds r0, #0xba
    movs r3, #0
    movs r2, #2
    ...
    b lbl_080621c6
    .align 2, 0
lbl_08062130: .4byte sNonGameplayRamPointer
lbl_08062134:
    ldr r2, lbl_08062150 @ =sNonGameplayRamPointer
    ldr r0, [r2]
    adds r0, #0xba
    movs r3, #2
    strb r3, [r0]
    ...
    b lbl_0806216e
    .align 2, 0
lbl_08062150: .4byte sNonGameplayRamPointer
lbl_08062154:
    ldr r2, lbl_08062178 @ =sNonGameplayRamPointer
    ldr r0, [r2]
    adds r0, #0xba
    movs r4, #0
    movs r3, #2
...
lbl_0806216e:
    ...
    b lbl_080621c6
    .align 2, 0
lbl_08062178: .4byte sNonGameplayRamPointer
lbl_0806217c:
    ldr r1, lbl_08062198 @ =sNonGameplayRamPointer
    ldr r0, [r1]
    adds r0, #0xba
    movs r3, #0
    movs r2, #2
    ...
    b lbl_080621b8
    .align 2, 0
lbl_08062198: .4byte sNonGameplayRamPointer
lbl_0806219c:
    ldr r2, lbl_080621c0 @ =sNonGameplayRamPointer
    ldr r0, [r2]
    adds r0, #0xba
    movs r1, #2
    strb r1, [r0]
...
lbl_080621b8:
    ...
    b lbl_080621c6
    .align 2, 0
lbl_080621c0: .4byte sNonGameplayRamPointer
lbl_080621c4:
    movs r7, #1
lbl_080621c6:
    adds r0, r7, #0
...
sub_080621d0: @ 0x080621d0
    ...
    movs r0, #0
    mov r8, r0
    ldr r7, lbl_08062204 @ =sNonGameplayRamPointer
    ldr r2, [r7]
    adds r3, r2, #0
    adds r3, #0xb8
    ldrh r0, [r3]
...
lbl_080621f8:
    ...
    b lbl_080623fe
    .align 2, 0
lbl_08062204: .4byte sNonGameplayRamPointer
lbl_08062208:
    cmp r0, #2
    beq lbl_080622dc
    cmp r0, #3
...
lbl_080623b0:
    ...
    bl BitFill
lbl_080623c6:
    ldr r2, lbl_080623e0 @ =sNonGameplayRamPointer
    ldr r0, [r2]
    adds r0, #0xbc
    movs r1, #1
    strb r1, [r0]

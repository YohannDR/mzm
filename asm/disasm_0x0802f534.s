...
WorkerRobotCheckSamusInFront: @ 0x0802f534
    ...
    push {r5, r6, r7}
    sub sp, #0x10
    ldr r0, lbl_0802f5d4 @ =0x03000738
    mov sl, r0
    ldrh r1, [r0]
    movs r0, #0x80
    lsls r0, r0, #5
    ...
    lsls r3, r3, #0x10
    lsrs r3, r3, #0x10
    ldr r4, lbl_0802f5d8 @ =0x030013d4
    ldrh r6, [r4, #0x14]
    mov r8, r6
    ldrh r7, [r4, #0x12]
    ldr r4, lbl_0802f5dc @ =0x03001588
    mov ip, r4
    adds r4, #0x70
    ldrh r6, [r4]
    add r6, r8
...
lbl_0802f5ce:
    ...
    b lbl_0802f5e6
    .align 2, 0
lbl_0802f5d4: .4byte 0x03000738
lbl_0802f5d8: .4byte 0x030013d4
lbl_0802f5dc: .4byte 0x03001588
lbl_0802f5e0:
    cmp sb, r7
    bhi lbl_0802f5ce
lbl_0802f5e4:
...
WorkerRobotInit: @ 0x0802f5f8
    push {r4, r5, lr}
    ldr r4, lbl_0802f678 @ =0x03000738
    movs r5, #0
    movs r1, #0
...
WorkerRobotSleepingInit: @ 0x0802f688
    ldr r1, lbl_0802f6a0 @ =0x03000738
    adds r2, r1, #0
    adds r2, #0x24
    movs r3, #0
    movs r0, #0x11
...
WorkerRobotWakingUpInit: @ 0x0802f6e0
    push {lr}
    ldr r1, lbl_0802f70c @ =0x03000738
    adds r2, r1, #0
    adds r2, #0x24
    movs r3, #0
    movs r0, #0x13
...
WorkerRobotChecWakingUpAnimEnded: @ 0x0802f718
    ...
    cmp r0, #0
    beq lbl_0802f72a
    ldr r0, lbl_0802f730 @ =0x03000738
    adds r0, #0x24
    movs r1, #0xe
    strb r1, [r0]
lbl_0802f72a:
...
WorkerRobotWalkingDetectProjectile: @ 0x0802f734
    ...
    movs r0, #0
    mov r8, r0
    ldr r3, lbl_0802f828 @ =0x03000738
    ldrh r1, [r3, #2]
    ldrh r2, [r3, #4]
    ldrh r0, [r3, #0xa]
    adds r0, r1, r0
    ...
    lsrs r2, r2, #0x10
    mov sl, r2
    ldr r4, lbl_0802f82c @ =0x03000a2c
    movs r1, #0xe0
    lsls r1, r1, #1
    adds r0, r4, r1
    cmp r4, r0
...
lbl_0802f7f8:
    ...
    beq lbl_0802f834
    ldr r5, [sp, #0x14]
    ldr r0, lbl_0802f828 @ =0x03000738
    ldrh r2, [r0]
    movs r7, #0x80
    lsls r7, r7, #2
    adds r1, r7, #0
    ...
    b lbl_0802f860
    .align 2, 0
lbl_0802f828: .4byte 0x03000738
lbl_0802f82c: .4byte 0x03000a2c
lbl_0802f830: .4byte 0x082e7b2c
lbl_0802f834:
    mov r5, sl
    ldr r0, lbl_0802f850 @ =0x03000738
    ldrh r1, [r0]
...
lbl_0802f86a:
    ...
    beq lbl_0802f8a6
    movs r0, #0x3c
    ldr r7, lbl_0802f88c @ =0x03000765
    strb r0, [r7]
    b lbl_0802f8a6
    .align 2, 0
lbl_0802f888: .4byte 0x082e7ae4
lbl_0802f88c: .4byte 0x03000765
lbl_0802f890:
    adds r0, r6, #0
    adds r1, r5, #0
    movs r2, #0x30
    ...
    beq lbl_0802f8a6
    movs r0, #0x1e
    ldr r1, lbl_0802f8ac @ =0x03000765
    strb r0, [r1]
lbl_0802f8a6:
    movs r0, #0
    strb r0, [r4]
    b lbl_0802f8ba
    .align 2, 0
lbl_0802f8ac: .4byte 0x03000765
lbl_0802f8b0:
    adds r4, #0x1c
    ldr r0, lbl_0802f8cc @ =0x03000bec
    cmp r4, r0
    bhs lbl_0802f8ba
    b lbl_0802f77e
lbl_0802f8ba:
...
WorkerRobotCheckProjectile: @ 0x0802f90c
    ...
    ldr r2, lbl_0802f928 @ =0x03000738
    adds r0, r2, #0
    adds r0, #0x2d
    ldrb r0, [r0]
    cmp r0, #0
...
WorkerRobotWalkingInit: @ 0x0802f948
    ldr r1, lbl_0802f960 @ =0x03000738
    adds r2, r1, #0
    adds r2, #0x24
    movs r3, #0
    movs r0, #9
...
WorkerRobotMove: @ 0x0802f968
    push {r4, r5, lr}
    bl unk_f594
    ldr r0, lbl_0802f9cc @ =0x030007f0
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0802f9ec
    ldr r4, lbl_0802f9d0 @ =0x03000738
    ldrh r0, [r4, #2]
    ldrh r1, [r4, #4]
    adds r1, #0x20
    bl SpriteUtilGetCollisionAtPosition
...
lbl_0802f9c4:
    ...
    b lbl_0802fbb4
    .align 2, 0
lbl_0802f9cc: .4byte 0x030007f0
lbl_0802f9d0: .4byte 0x03000738
lbl_0802f9d4:
    movs r0, #0x80
    lsls r0, r0, #2
    ands r0, r1
...
lbl_0802f9ec:
    movs r5, #1
    bl WorkerRobotWalkingDetectProjectile
    ldr r2, lbl_0802fa38 @ =0x03000738
    adds r0, r2, #0
    adds r0, #0x2d
    ldrb r0, [r0]
    cmp r0, #0
    ...
    bl SoundPlayNotAlreadyPlaying
lbl_0802fa1e:
    ldr r0, lbl_0802fa38 @ =0x03000738
    ldrb r1, [r0, #0x1c]
    adds r1, #4
    strb r1, [r0, #0x1c]
    adds r1, r0, #0
...
lbl_0802fab4:
    ...
    cmp r0, #0
    beq lbl_0802fad0
    ldr r0, lbl_0802facc @ =0x03000738
    adds r0, #0x24
    movs r1, #0xa
    strb r1, [r0]
    b lbl_0802fbb4
...
lbl_0802facc: .4byte 0x03000738
lbl_0802fad0:
    ldr r4, lbl_0802fb34 @ =0x03000738
    ldrh r1, [r4]
    movs r0, #0x80
    lsls r0, r0, #2
    ands r0, r1
    cmp r0, #0
    beq lbl_0802fb40
    ldr r0, lbl_0802fb38 @ =0x030007f0
    ldrb r1, [r0]
    movs r0, #0xf0
    ands r0, r1
    cmp r0, #0
...
lbl_0802fb02:
    ...
    beq lbl_0802fb7a
lbl_0802fb18:
    ldr r1, lbl_0802fb34 @ =0x03000738
    ldrh r0, [r1, #4]
    adds r0, r5, r0
    strh r0, [r1, #4]
    ldrh r1, [r1]
    ...
    cmp r0, #0
    beq lbl_0802fbb4
    ldr r1, lbl_0802fb3c @ =0x030013d4
    ldrh r0, [r1, #0x12]
    adds r0, r5, r0
    b lbl_0802fbb2
    .align 2, 0
lbl_0802fb34: .4byte 0x03000738
lbl_0802fb38: .4byte 0x030007f0
lbl_0802fb3c: .4byte 0x030013d4
lbl_0802fb40:
    ldr r0, lbl_0802fb90 @ =0x030007f0
    ldrb r1, [r0]
    movs r0, #0xf0
    ands r0, r1
    cmp r0, #0
    ...
    beq lbl_0802fb84
lbl_0802fb64:
    ldr r4, lbl_0802fb94 @ =0x03000738
    ldrh r0, [r4, #2]
    subs r0, #0x48
    ldrh r1, [r4, #4]
    subs r1, #0x28
...
lbl_0802fb84:
    ...
    b lbl_0802fbb4
    .align 2, 0
lbl_0802fb90: .4byte 0x030007f0
lbl_0802fb94: .4byte 0x03000738
lbl_0802fb98:
    ldr r1, lbl_0802fbbc @ =0x03000738
    ldrh r0, [r1, #4]
    subs r0, r0, r5
    strh r0, [r1, #4]
    ldrh r1, [r1]
    ...
    cmp r0, #0
    beq lbl_0802fbb4
    ldr r1, lbl_0802fbc0 @ =0x030013d4
    ldrh r0, [r1, #0x12]
    subs r0, r0, r5
lbl_0802fbb2:
    strh r0, [r1, #0x12]
lbl_0802fbb4:
    ...
    bx r0
    .align 2, 0
lbl_0802fbbc: .4byte 0x03000738
lbl_0802fbc0: .4byte 0x030013d4

    thumb_func_start WorkerRobotBackToSleepInit
WorkerRobotBackToSleepInit: @ 0x0802fbc4
    push {lr}
    ldr r1, lbl_0802fbf4 @ =0x03000738
    adds r2, r1, #0
    adds r2, #0x24
    movs r3, #0
    movs r0, #0xb
...
WorkerRobotCheckBackToSleepAnimEnded: @ 0x0802fbfc
    ...
    cmp r0, #0
    beq lbl_0802fc1e
    ldr r1, lbl_0802fc24 @ =0x03000738
    adds r2, r1, #0
    adds r2, #0x24
    movs r3, #0
    movs r0, #0xc
...
WorkerRobotTurningAround: @ 0x0802fc30
    ...
    cmp r0, #0
    beq lbl_0802fc74
    ldr r1, lbl_0802fc50 @ =0x03000738
    ldrh r2, [r1]
    movs r0, #0x40
    ands r0, r2
    adds r3, r1, #0
...
WorkerRobotCheckTurningAroundAnimEnded: @ 0x0802fc7c
    ...
    cmp r0, #0
    beq lbl_0802fc8e
    ldr r0, lbl_0802fc94 @ =0x03000738
    adds r0, #0x24
    movs r1, #0x10
    strb r1, [r0]
lbl_0802fc8e:
...
WorkerRobotFalling: @ 0x0802fcc0
    ...
    adds r1, r0, #0
    ldr r0, lbl_0802fcf4 @ =0x030007f0
    ldrb r0, [r0]
    cmp r0, #0
    beq lbl_0802fcfc
    strh r1, [r4, #2]
    ...
    b lbl_0802fd38
    .align 2, 0
lbl_0802fcf0: .4byte 0x03000738
lbl_0802fcf4: .4byte 0x030007f0
...
sub_0802fd40: @ 0x0802fd40
    ldr r3, lbl_0802fd58 @ =0x03000738
    adds r1, r3, #0
    adds r1, #0x24
    movs r2, #0
    movs r0, #0x21
    ...
    bx lr
    .align 2, 0
lbl_0802fd58: .4byte 0x03000738

    thumb_func_start WorkerRobotFallingSleep
WorkerRobotFallingSleep: @ 0x0802fd5c
    push {r4, r5, lr}
    ldr r4, lbl_0802fd84 @ =0x03000738
    ldrh r0, [r4, #2]
    ldrh r1, [r4, #4]
    bl SpriteUtilCheckVerticalCollisionAtPositionSlopes
    adds r1, r0, #0
    ldr r0, lbl_0802fd88 @ =0x030007f0
    ldrb r0, [r0]
    cmp r0, #0
    beq lbl_0802fd90
    strh r1, [r4, #2]
    ...
    b lbl_0802fdcc
    .align 2, 0
lbl_0802fd84: .4byte 0x03000738
lbl_0802fd88: .4byte 0x030007f0
...
WorkerRobot: @ 0x0802fdd4
    push {lr}
    sub sp, #4
    ldr r1, lbl_0802fdf0 @ =0x03000738
    adds r0, r1, #0
    adds r0, #0x24
    ldrb r0, [r0]
    adds r2, r1, #0
...
sub_0802fef0: @ 0x0802fef0
    push {r4, lr}
    movs r4, #0
    ldr r2, lbl_0802ff28 @ =0x030001ac
    movs r1, #0xa8
    lsls r1, r1, #3
    adds r0, r2, r1
    cmp r2, r0
...
lbl_0802ff20:
    ...
    b lbl_0802ff38
    .align 2, 0
lbl_0802ff28: .4byte 0x030001ac
lbl_0802ff2c:
    adds r3, #0x38
    adds r2, #0x38
    ldr r0, lbl_0802ff40 @ =0x030006ec
    cmp r2, r0
    blo lbl_0802ff04
lbl_0802ff36:
    movs r0, #0
...
ParasiteInit: @ 0x0802ff44
    ...
    movs r0, #1
    strh r0, [r6, #0x14]
    ldr r0, lbl_0802ffe4 @ =0x0300070c
    strb r3, [r0, #0xe]
    ...
    cmp r0, #0x5e
    bne lbl_08030062
    ldr r0, lbl_0802ffe8 @ =0x03001530
    ldrb r1, [r0, #0xc]
    movs r0, #0x80
    ands r0, r1
    cmp r0, #0
    ...
    cmp r0, #0
    bne lbl_0802ffb8
    ldr r1, lbl_0802ffec @ =0x0300007b
    movs r0, #1
    strb r0, [r1]
lbl_0802ffb8:
    ldrh r1, [r6]
    ...
    cmp r5, #0
    beq lbl_0802fff8
    ldr r0, lbl_0802fff0 @ =0x0300083c
    ldrb r7, [r0]
...
lbl_0802ffe4: .4byte 0x0300070c
lbl_0802ffe8: .4byte 0x03001530
lbl_0802ffec: .4byte 0x0300007b
lbl_0802fff0: .4byte 0x0300083c
...
ParasiteGrabSamus: @ 0x08030070
    ...
    adds r0, #0x2c
    strb r1, [r0]
    ldr r2, lbl_080300bc @ =0x030013d4
    ldr r1, lbl_080300c0 @ =0x03001588
    adds r0, r1, #0
    adds r0, #0x70
    ldrh r0, [r0]
    ldrh r4, [r2, #0x14]
...
lbl_080300bc: .4byte 0x030013d4
lbl_080300c0: .4byte 0x03001588
lbl_080300c4:
    subs r0, r0, r4
    strh r0, [r3, #6]
lbl_080300c8:
...
ParasiteSamusGrabbed: @ 0x08030100
    push {r4, r5, r6, r7, lr}
    adds r3, r0, #0
    ldr r0, lbl_08030128 @ =0x030013d4
    ldrb r1, [r0]
    adds r6, r0, #0
    cmp r1, #0xf
    bne lbl_08030130
    ...
    movs r1, #0x44
    strb r1, [r0]
    ldr r0, lbl_0803012c @ =0x0300083c
    ldrb r2, [r0]
    cmp r2, #5
    bhi lbl_08030120
    movs r2, #6
lbl_08030120:
    ...
    b lbl_08030288
    .align 2, 0
lbl_08030128: .4byte 0x030013d4
lbl_0803012c: .4byte 0x0300083c
lbl_08030130:
    ldr r1, lbl_0803016c @ =0x03000734
    ldrb r0, [r1]
    cmp r0, #0
    bne lbl_0803013c
    movs r0, #0x5a
...
lbl_0803013c:
    ...
    cmp r0, #0
    beq lbl_08030178
    ldr r2, lbl_08030170 @ =0x03001588
    adds r0, r2, #0
    adds r0, #0x74
    movs r5, #0
    ldrsh r1, [r0, r5]
    ...
    b lbl_08030198
    .align 2, 0
lbl_0803016c: .4byte 0x03000734
lbl_08030170: .4byte 0x03001588
lbl_08030174: .4byte 0x0000feff
lbl_08030178:
    ldr r2, lbl_080301c4 @ =0x03001588
    adds r0, r2, #0
    adds r0, #0x70
    movs r7, #0
    ldrsh r1, [r0, r7]
...
lbl_08030198:
    strh r0, [r3]
    ldr r0, lbl_080301c8 @ =0x0300083c
    ldrb r0, [r0]
    strb r0, [r2]
lbl_080301a0:
    ldrh r4, [r3]
    ...
    b lbl_080301e8
    .align 2, 0
lbl_080301c4: .4byte 0x03001588
lbl_080301c8: .4byte 0x0300083c
...
lbl_080301e8:
    strh r0, [r3]
    ldr r0, lbl_08030214 @ =0x0300083c
    ldrb r0, [r0]
    strb r0, [r2]
lbl_080301f0:
    ldrb r0, [r2]
    ...
    b lbl_08030226
    .align 2, 0
lbl_08030214: .4byte 0x0300083c
lbl_08030218:
    ldr r0, lbl_08030244 @ =0x0300083c
    ldrb r1, [r0]
    adds r2, r0, #0
    cmp r1, #0
    beq lbl_08030228
...
lbl_08030426:
    ...
    bl SpriteUtilCheckVerticalCollisionAtPositionSlopes
    adds r2, r0, #0
    ldr r0, lbl_0803045c @ =0x030007f0
    ldrb r0, [r0]
    cmp r0, #0
    beq lbl_08030490
    ldr r1, lbl_08030460 @ =0x0300083c
    ldrb r0, [r1]
    cmp r0, #8
    bls lbl_08030468
    ...
    b lbl_0803047e
    .align 2, 0
lbl_0803045c: .4byte 0x030007f0
lbl_08030460: .4byte 0x0300083c
...
lbl_08030508:
    ...
    movs r1, #0xf
    strb r1, [r0]
    ldr r1, lbl_08030554 @ =0x0300083c
    ldrb r0, [r1]
    cmp r0, #8
    bls lbl_0803055c
...
lbl_08030774:
    ...
    bl SpriteUtilCheckVerticalCollisionAtPositionSlopes
    adds r2, r0, #0
    ldr r0, lbl_080307a8 @ =0x030007f0
    ldrb r0, [r0]
    cmp r0, #0
    beq lbl_080307b0
...
ParasiteIdleInit: @ 0x080308cc
    ...
    strh r2, [r3, #0x16]
    strb r0, [r3, #0x1c]
    ldr r4, lbl_08030918 @ =0x0300083c
    ldrb r0, [r4]
    lsrs r0, r0, #1
    cmp r0, #5
    bhi lbl_080308f0
...
lbl_0803093a:
    bl unk_f594
    ldr r0, lbl_08030950 @ =0x030007f0
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_08030954
    adds r1, r5, #0
...
lbl_0803096c:
    ...
    adds r2, #0x2c
    ldrb r4, [r2]
    ldr r0, lbl_0803099c @ =0x03000c77
    ldrb r0, [r0]
    lsrs r1, r0, #4
    cmp r1, r4
    bne lbl_080309a8
    ...
    strh r6, [r5, #0x16]
    strb r0, [r5, #0x1c]
    ldr r0, lbl_080309a4 @ =0x0300083c
    ldrb r1, [r0]
    lsls r0, r1, #1
    adds r0, r0, r1
    strb r0, [r2]
    ...
    b lbl_08030aae
    .align 2, 0
lbl_0803099c: .4byte 0x03000c77
lbl_080309a0: .4byte 0x082e8350
lbl_080309a4: .4byte 0x0300083c
lbl_080309a8:
    adds r0, r4, #1
    cmp r1, r0
    beq lbl_080309b4
...
lbl_080309b4:
    ...
    strh r6, [r5, #0x16]
    strb r0, [r5, #0x1c]
    ldr r0, lbl_080309e0 @ =0x0300083c
    ldrb r1, [r0]
    cmp r1, #3
    bhi lbl_080309e4
    adds r1, r5, #0
...
lbl_08030a20:
    ldr r6, lbl_08030a40 @ =0x03000734
    ldrb r0, [r6]
    cmp r0, #0
    bne lbl_08030a44
    movs r0, #0x60
...
lbl_08030a4a:
    ...
    cmp r0, #0
    beq lbl_08030a7c
    ldr r0, lbl_08030a78 @ =0x030007f0
    ldrb r1, [r0]
    movs r0, #0xf0
    ands r0, r1
    cmp r0, #0
...
lbl_08030a70:
    ...
    b lbl_08030aac
    .align 2, 0
lbl_08030a78: .4byte 0x030007f0
lbl_08030a7c:
    ldr r0, lbl_08030aa4 @ =0x030007f0
    ldrb r1, [r0]
    movs r0, #0xf0
    ands r0, r1
    cmp r0, #0
...
lbl_08030ace:
    ...
    cmp r0, #0
    beq lbl_08030af0
    ldr r0, lbl_08030aec @ =0x03000c77
    ldrb r1, [r0]
    adds r0, r2, #0
    ands r0, r1
    cmp r0, #0
    ...
    b lbl_08030afc
    .align 2, 0
lbl_08030aec: .4byte 0x03000c77
lbl_08030af0:
    ldr r0, lbl_08030b1c @ =0x03000c77
    ldrb r1, [r0]
    adds r0, r2, #0
    ands r0, r1
    cmp r0, #0
...
lbl_08030afc:
    ...
    b lbl_08030c52
    .align 2, 0
lbl_08030b1c: .4byte 0x03000c77
lbl_08030b20:
    adds r2, r4, #0
    adds r2, #0x2c
    ldrb r5, [r2]
    ldr r0, lbl_08030b54 @ =0x03000c77
    ldrb r0, [r0]
    lsrs r0, r0, #4
    adds r1, r0, #0
    cmp r1, r5
    ...
    strh r0, [r4, #0x16]
    strb r1, [r4, #0x1c]
    ldr r0, lbl_08030b5c @ =0x0300083c
    ldrb r1, [r0]
    lsls r0, r1, #1
    adds r0, r0, r1
    strb r0, [r2]
    ...
    b lbl_08030c52
    .align 2, 0
lbl_08030b54: .4byte 0x03000c77
lbl_08030b58: .4byte 0x082e8350
lbl_08030b5c: .4byte 0x0300083c
lbl_08030b60:
    adds r0, r5, #1
    cmp r1, r0
    beq lbl_08030b6c
...
lbl_08030b6c:
    ...
    strh r2, [r4, #0x16]
    strb r0, [r4, #0x1c]
    ldr r0, lbl_08030b98 @ =0x0300083c
    ldrb r1, [r0]
    cmp r1, #3
    bhi lbl_08030b9c
    adds r1, r4, #0
...
lbl_08030bd8:
    ldr r6, lbl_08030bf8 @ =0x03000734
    ldrb r0, [r6]
    cmp r0, #0
    bne lbl_08030bfc
    movs r0, #0x60
...
lbl_08030d4a:
    ...
    beq lbl_08030d6c
lbl_08030d4e:
    ldr r0, lbl_08030d60 @ =0x0300083c
    ldrb r0, [r0]
    cmp r0, #6
    bls lbl_08030d64
    adds r1, r4, #0
...
lbl_08030dc0:
    ...
    bl SpriteUtilCheckVerticalCollisionAtPositionSlopes
    adds r1, r0, #0
    ldr r0, lbl_08030de0 @ =0x030007f0
    ldrb r0, [r0]
    cmp r0, #0
    beq lbl_08030de4
    strh r1, [r4, #2]
...
sub_08030df8: @ 0x08030df8
    ...
    strh r3, [r0, #0x16]
    strb r4, [r0, #0x1c]
    ldr r1, lbl_08030e30 @ =0x03000088
    ldrb r2, [r1, #0xc]
    movs r1, #3
    ands r1, r2
    adds r0, #0x21
...
ParasiteMultipleDying: @ 0x08030e54
    ...
    beq lbl_08030ea6
    strh r5, [r4]
    ldr r2, lbl_08030eac @ =0x030001ac
    adds r0, r4, #0
    adds r0, #0x23
    ldrb r1, [r0]
    lsls r0, r1, #3
    ...
    movs r1, #0x2d
    bl EventFunction
    ldr r1, lbl_08030eb0 @ =0x0300007b
    movs r2, #0x14
    rsbs r2, r2, #0
    adds r0, r2, #0
    strb r0, [r1]
lbl_08030ea6:
    ...
    bx r0
    .align 2, 0
lbl_08030eac: .4byte 0x030001ac
lbl_08030eb0: .4byte 0x0300007b
...
sub_08030eb4: @ 0x08030eb4
    ...
    adds r0, #1
    ldrb r4, [r0]
    ldr r2, lbl_08030f04 @ =0x030001ac
    lsls r1, r4, #3
    subs r1, r1, r4
    lsls r1, r1, #3
    adds r1, r1, r2
...
sub_08030f4c: @ 0x08030f4c
    ...
    adds r0, #0x2d
    ldrb r6, [r0]
    ldr r1, lbl_08030f94 @ =0x030001ac
    lsls r0, r6, #3
    subs r0, r0, r6
    lsls r0, r0, #3
    adds r2, r0, r1
    ...
    movs r1, #0x44
    strb r1, [r0]
    ldr r0, lbl_08030f98 @ =0x0300083c
    ldrb r0, [r0]
    cmp r0, #5
    bhi lbl_08030f7c
    movs r0, #6
lbl_08030f7c:
    ...
    b lbl_080310e2
    .align 2, 0
lbl_08030f94: .4byte 0x030001ac
lbl_08030f98: .4byte 0x0300083c
lbl_08030f9c: .4byte 0x00007fff
lbl_08030fa0:
    ldr r1, lbl_08030fd0 @ =0x03000734
    ldrb r0, [r1]
    cmp r0, #0
    bne lbl_08030fac
    movs r0, #0x5a
...
lbl_08030ff0:
    strh r0, [r3]
    ldr r0, lbl_08031020 @ =0x0300083c
    ldrb r0, [r0]
    strb r0, [r4]
lbl_08030ff8:
    ldrh r5, [r3]
...
lbl_08031044:
    strh r0, [r3]
    ldr r0, lbl_08031070 @ =0x0300083c
    ldrb r0, [r0]
    strb r0, [r4]
lbl_0803104c:
    ldrb r0, [r4]
    ...
    b lbl_08031082
    .align 2, 0
lbl_08031070: .4byte 0x0300083c
lbl_08031074:
    ldr r0, lbl_080310a0 @ =0x0300083c
    ldrb r1, [r0]
    adds r4, r0, #0
    cmp r1, #0
    beq lbl_08031084
...
lbl_08031114:
    ...
    lsrs r1, r1, #0x10
    mov r8, r1
    ldr r5, lbl_080311bc @ =0x03000a2c
    movs r1, #0xe0
    lsls r1, r1, #1
    adds r0, r5, r1
    movs r1, #0x24
...
lbl_080311a6:
    adds r5, #0x1c
    ldr r0, lbl_080311c0 @ =0x03000bec
    cmp r5, r0
    blo lbl_08031154
lbl_080311ae:
    cmp r7, #0
    ...
    b lbl_080311ea
    .align 2, 0
lbl_080311bc: .4byte 0x03000a2c
lbl_080311c0: .4byte 0x03000bec
lbl_080311c4:
    adds r0, r6, #0
    adds r0, #0x2b
    strb r7, [r0]
    ...
    mov r1, sl
    strb r0, [r1]
    ldr r0, lbl_080311fc @ =0x0300083c
    ldrb r0, [r0]
    lsrs r7, r0, #1
    cmp r7, #8
    bhi lbl_080311e0
...
Parasite: @ 0x0803147c
    push {r4, lr}
    ldr r4, lbl_080314b4 @ =0x03000738
    adds r0, r4, #0
    adds r0, #0x2b
    ldrb r1, [r0]
    movs r0, #0x7f

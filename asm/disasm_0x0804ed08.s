...
set_beam_particle_effect: @ 0x0804ed08
    push {r4, r5, lr}
    ldr r0, lbl_0804ed30 @ =0x03000bec
    ldrh r5, [r0]
    ldr r0, lbl_0804ed34 @ =0x03000bee
    ldrh r4, [r0]
    ldr r2, lbl_0804ed38 @ =0x030013d4
    ldrh r1, [r2, #0xe]
    movs r0, #0x10
    ands r0, r1
    lsls r0, r0, #0x10
    ...
    mov pc, r0
    .align 2, 0
lbl_0804ed30: .4byte 0x03000bec
lbl_0804ed34: .4byte 0x03000bee
lbl_0804ed38: .4byte 0x030013d4
...
check_number_of_projectiles: @ 0x0804ed94
    ...
    lsrs r4, r1, #0x18
    movs r3, #0
    ldr r2, lbl_0804edd0 @ =0x03000a2c
    movs r1, #0xe0
    lsls r1, r1, #1
    adds r0, r2, r1
    cmp r2, r0
...
initialize_projectile: @ 0x0804ede4
    ...
    lsrs r2, r2, #0x10
    mov r8, r2
    ldr r3, lbl_0804ee60 @ =0x03000a2c
    movs r1, #0xe0
    lsls r1, r1, #1
    adds r0, r3, r1
    cmp r3, r0
    bhs lbl_0804ee74
    movs r5, #1
    ldr r0, lbl_0804ee64 @ =0x030013d4
    mov ip, r0
    movs r7, #0
...
lbl_0804ee36:
    ...
    b lbl_0804ee76
    .align 2, 0
lbl_0804ee60: .4byte 0x03000a2c
lbl_0804ee64: .4byte 0x030013d4
lbl_0804ee68: .4byte 0x0000ffff
lbl_0804ee6c:
    adds r3, #0x1c
    ldr r0, lbl_0804ee84 @ =0x03000bec
    cmp r3, r0
    blo lbl_0804ee14
lbl_0804ee74:
    movs r0, #0
...
lbl_0804ee96:
    ...
    ldr r4, lbl_0804ef1c @ =0x03000bec
    ldr r3, lbl_0804ef20 @ =0x030013d4
    ldrh r0, [r3, #0x14]
    ldr r1, lbl_0804ef24 @ =0x03001588
    adds r2, r1, #0
    adds r2, #0x4c
    lsrs r0, r0, #2
    ldrh r2, [r2]
    ...
    lsls r0, r0, #2
    strh r0, [r4]
    ldr r2, lbl_0804ef28 @ =0x03000bee
    ldrh r0, [r3, #0x12]
    adds r1, #0x4a
    lsrs r0, r0, #2
    ldrh r1, [r1]
    ...
    lsls r0, r0, #2
    strh r0, [r2]
    ldr r0, lbl_0804ef2c @ =0x03001414
    ldrb r0, [r0, #5]
    cmp r0, #0x10
    bne lbl_0804ef02
    ldr r0, lbl_0804ef30 @ =0x03001530
    ldrb r0, [r0, #0x12]
    cmp r0, #2
    beq lbl_0804ef02
    movs r4, #0
    movs r3, #0
    movs r5, #1
    ldr r2, lbl_0804ef34 @ =0x03000840
lbl_0804eed8:
    ldrb r1, [r2]
    adds r0, r5, #0
    ands r0, r1
...
lbl_0804eef0:
    cmp r4, #0
    bne lbl_0804ef02
    ldr r0, lbl_0804ef1c @ =0x03000bec
    ldrh r0, [r0]
    ldr r1, lbl_0804ef28 @ =0x03000bee
    ldrh r1, [r1]
    movs r2, #0x3b
    bl ParticleSet
lbl_0804ef02:
...
lbl_0804ef0e:
    ...
    mov pc, r0
    .align 2, 0
lbl_0804ef18: .4byte 0x03000c72
lbl_0804ef1c: .4byte 0x03000bec
lbl_0804ef20: .4byte 0x030013d4
lbl_0804ef24: .4byte 0x03001588
lbl_0804ef28: .4byte 0x03000bee
lbl_0804ef2c: .4byte 0x03001414
lbl_0804ef30: .4byte 0x03001530
lbl_0804ef34: .4byte 0x03000840
...
lbl_0804ef54:
    ...
    b lbl_0804eef0
lbl_0804ef5c:
    ldr r1, lbl_0804efa0 @ =0x03001530
    ldrb r0, [r1, #0x12]
    cmp r0, #2
    bne lbl_0804efb0
    movs r0, #0xb
    ...
    b lbl_0804f2a2
lbl_0804ef74:
    ldr r0, lbl_0804efa4 @ =0x03000bec
    ldrh r1, [r0]
    ldr r0, lbl_0804efa8 @ =0x03000bee
    ldrh r2, [r0]
    movs r0, #0xb
    ...
    b lbl_0804f2a2
lbl_0804ef8a:
    ldr r4, lbl_0804efac @ =0x03001414
    movs r0, #7
    strb r0, [r4, #4]
    ...
    b lbl_0804f2a2
    .align 2, 0
lbl_0804efa0: .4byte 0x03001530
lbl_0804efa4: .4byte 0x03000bec
lbl_0804efa8: .4byte 0x03000bee
lbl_0804efac: .4byte 0x03001414
lbl_0804efb0:
    ldrb r1, [r1, #0xd]
    movs r0, #8
    ands r0, r1
...
lbl_0804f064:
    ...
    b lbl_0804f178
lbl_0804f06a:
    ldr r1, lbl_0804f0b0 @ =0x03001530
    ldrb r0, [r1, #0x12]
    cmp r0, #2
    bne lbl_0804f0c0
    movs r0, #5
    ...
    b lbl_0804f2a2
lbl_0804f082:
    ldr r0, lbl_0804f0b4 @ =0x03000bec
    ldrh r1, [r0]
    ldr r0, lbl_0804f0b8 @ =0x03000bee
    ldrh r2, [r0]
    movs r0, #5
    bl initialize_projectile
    lsls r0, r0, #0x18
    ...
    b lbl_0804f2a2
lbl_0804f098:
    ldr r4, lbl_0804f0bc @ =0x03001414
    movs r0, #7
    strb r0, [r4, #4]
    bl set_beam_particle_effect
    movs r0, #4
    ...
    b lbl_0804f2a2
    .align 2, 0
lbl_0804f0b0: .4byte 0x03001530
lbl_0804f0b4: .4byte 0x03000bec
lbl_0804f0b8: .4byte 0x03000bee
lbl_0804f0bc: .4byte 0x03001414
lbl_0804f0c0:
    ldrb r1, [r1, #0xd]
    movs r0, #8
    ands r0, r1
...
lbl_0804f178:
    ...
    b lbl_0804f2a2
lbl_0804f184:
    ldr r0, lbl_0804f1b0 @ =0x03000bec
    ldrh r1, [r0]
    ldr r0, lbl_0804f1b4 @ =0x03000bee
    ldrh r2, [r0]
    adds r0, r4, #0
    bl initialize_projectile
    lsls r0, r0, #0x18
    ...
    b lbl_0804f2a2
lbl_0804f19a:
    ldr r4, lbl_0804f1b8 @ =0x03001414
    movs r0, #7
    strb r0, [r4, #4]
    bl set_beam_particle_effect
    movs r0, #4
    ...
    b lbl_0804f2a2
    .align 2, 0
lbl_0804f1b0: .4byte 0x03000bec
lbl_0804f1b4: .4byte 0x03000bee
lbl_0804f1b8: .4byte 0x03001414
lbl_0804f1bc:
    movs r0, #0xc
    movs r1, #4
    bl check_number_of_projectiles
    ...
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r0, lbl_0804f1f4 @ =0x03000bec
    ldrh r1, [r0]
    ldr r0, lbl_0804f1f8 @ =0x03000bee
    ldrh r2, [r0]
    movs r0, #0xc
    bl initialize_projectile
    lsls r0, r0, #0x18
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r1, lbl_0804f1fc @ =0x03001414
    movs r0, #9
    strb r0, [r1, #4]
    movs r0, #0xf8
    bl SoundPlay
    ...
    b lbl_0804f2a2
    .align 2, 0
lbl_0804f1f4: .4byte 0x03000bec
lbl_0804f1f8: .4byte 0x03000bee
lbl_0804f1fc: .4byte 0x03001414
lbl_0804f200:
    movs r0, #0xd
    movs r1, #4
    bl check_number_of_projectiles
    ...
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r0, lbl_0804f238 @ =0x03000bec
    ldrh r1, [r0]
    ldr r0, lbl_0804f23c @ =0x03000bee
    ldrh r2, [r0]
    movs r0, #0xd
    bl initialize_projectile
    lsls r0, r0, #0x18
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r1, lbl_0804f240 @ =0x03001414
    movs r0, #0xb
    strb r0, [r1, #4]
    movs r0, #0xfb
    bl SoundPlay
    ...
    b lbl_0804f2a2
    .align 2, 0
lbl_0804f238: .4byte 0x03000bec
lbl_0804f23c: .4byte 0x03000bee
lbl_0804f240: .4byte 0x03001414
lbl_0804f244:
    movs r0, #0xe
    movs r1, #4
    bl check_number_of_projectiles
    ...
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r0, lbl_0804f26c @ =0x030013d4
    ldrh r1, [r0, #0x14]
    ldrh r2, [r0, #0x12]
    movs r0, #0xe
    bl initialize_projectile
    ...
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r1, lbl_0804f270 @ =0x03001414
    movs r0, #7
    b lbl_0804f2a0
    .align 2, 0
lbl_0804f26c: .4byte 0x030013d4
lbl_0804f270: .4byte 0x03001414
lbl_0804f274:
    movs r0, #0xf
    movs r1, #1
    bl check_number_of_projectiles
    ...
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r0, lbl_0804f2ec @ =0x03000130
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0804f2a2
    ldr r0, lbl_0804f2f0 @ =0x030013d4
    ldrh r1, [r0, #0x14]
    ldrh r2, [r0, #0x12]
    movs r0, #0xf
    bl initialize_projectile
    ...
    cmp r0, #0
    beq lbl_0804f2a2
    ldr r1, lbl_0804f2f4 @ =0x03001414
    movs r0, #5
lbl_0804f2a0:
    strb r0, [r1, #4]
lbl_0804f2a2:
...
lbl_0804f2a8:
    ...
    ldr r4, lbl_0804f2f8 @ =0x03000a2c
    movs r1, #0xe0
    lsls r1, r1, #1
    adds r0, r4, r1
    cmp r4, r0
...
lbl_0804f2de:
    adds r4, #0x1c
    ldr r0, lbl_0804f300 @ =0x03000bec
    cmp r4, r0
    blo lbl_0804f2ba
lbl_0804f2e6:
    pop {r4, r5}
    ...
    bx r0
    .align 2, 0
lbl_0804f2ec: .4byte 0x03000130
lbl_0804f2f0: .4byte 0x030013d4
lbl_0804f2f4: .4byte 0x03001414
lbl_0804f2f8: .4byte 0x03000a2c
lbl_0804f2fc: .4byte 0x0875f974
lbl_0804f300: .4byte 0x03000bec
...
ProjectileDrawAllStatusFalse: @ 0x0804f33c
    push {r4, lr}
    ldr r0, lbl_0804f374 @ =0x03000c72
    movs r1, #0
    ldrsh r0, [r0, r1]
    cmp r0, #2
    bne lbl_0804f36c
    ldr r4, lbl_0804f378 @ =0x03000a2c
    movs r1, #0xe0
    lsls r1, r1, #1
    adds r0, r4, r1
    cmp r4, r0
...
lbl_0804f364:
    adds r4, #0x1c
    ldr r0, lbl_0804f37c @ =0x03000bec
    cmp r4, r0
    blo lbl_0804f354
lbl_0804f36c:
    pop {r4}
    ...
    bx r0
    .align 2, 0
lbl_0804f374: .4byte 0x03000c72
lbl_0804f378: .4byte 0x03000a2c
lbl_0804f37c: .4byte 0x03000bec

    thumb_func_start ProjectileDrawAllStatusTrue
ProjectileDrawAllStatusTrue: @ 0x0804f380
    push {r4, lr}
    ldr r0, lbl_0804f3b8 @ =0x03000c72
    movs r1, #0
    ldrsh r0, [r0, r1]
    cmp r0, #2
    bne lbl_0804f3b0
    ldr r4, lbl_0804f3bc @ =0x03000a2c
    movs r1, #0xe0
    lsls r1, r1, #1
    adds r0, r4, r1
    cmp r4, r0
...
lbl_0804f3a8:
    adds r4, #0x1c
    ldr r0, lbl_0804f3c0 @ =0x03000bec
    cmp r4, r0
    blo lbl_0804f398
lbl_0804f3b0:
    pop {r4}
    ...
    bx r0
    .align 2, 0
lbl_0804f3b8: .4byte 0x03000c72
lbl_0804f3bc: .4byte 0x03000a2c
lbl_0804f3c0: .4byte 0x03000bec
...
draw_projectile: @ 0x0804f3c4
    ...
    sub sp, #0x18
    adds r3, r0, #0
    ldr r2, lbl_0804f448 @ =0x03001382
    ldrb r0, [r2]
    str r0, [sp, #4]
    ldrh r0, [r3, #0xc]
    ldr r1, [r3, #4]
...
lbl_0804f3f2:
    ldr r1, [sp, #4]
    lsls r0, r1, #3
    ldr r2, lbl_0804f44c @ =0x03000e7c
    adds r4, r0, r2
    ldrh r1, [r3, #8]
    lsrs r1, r1, #2
    ldr r0, lbl_0804f450 @ =0x030013ba
    ldrh r0, [r0]
    lsrs r0, r0, #2
    subs r1, r1, r0
    lsls r1, r1, #0x10
    ...
    ldrh r1, [r3, #0xa]
    lsrs r1, r1, #2
    ldr r0, lbl_0804f454 @ =0x030013b8
    ldrh r0, [r0]
    lsrs r0, r0, #2
    subs r1, r1, r0
    lsls r1, r1, #0x10
    ...
    lsrs r0, r0, #0x18
    str r0, [sp, #0xc]
    ldr r0, lbl_0804f458 @ =0x03000088
    ldrh r0, [r0, #0xc]
    movs r3, #3
    ands r3, r0
    movs r0, #8
    ...
    b lbl_0804f45e
    .align 2, 0
lbl_0804f448: .4byte 0x03001382
lbl_0804f44c: .4byte 0x03000e7c
lbl_0804f450: .4byte 0x030013ba
lbl_0804f454: .4byte 0x030013b8
lbl_0804f458: .4byte 0x03000088
lbl_0804f45c:
    adds r3, #1
lbl_0804f45e:
    movs r0, #0
...
lbl_0804f478:
    ...
    add r0, ip
    lsls r0, r0, #3
    ldr r1, lbl_0804f560 @ =0x03000e7c
    adds r3, r0, r1
    ldr r1, [sp]
    adds r0, r7, r1
    strb r0, [r3]
...
lbl_0804f548:
    mov r1, sp
    ldrb r0, [r1, #0x14]
    ldr r1, lbl_0804f574 @ =0x03001382
    strb r0, [r1]
lbl_0804f550:
    add sp, #0x18
    pop {r3, r4, r5}
...
check_despawn_projectile: @ 0x0804f578
    ...
    cmp r0, #0
    beq lbl_0804f65e
    ldr r0, lbl_0804f604 @ =0x030013ba
    ldrh r7, [r6, #8]
    ldrh r4, [r6, #0xa]
    mov ip, r4
    ldrb r3, [r6, #0x12]
    ...
    lsrs r1, r1, #0x10
    mov r8, r1
    ldr r1, lbl_0804f608 @ =0x030013b8
    ldrh r1, [r1]
    adds r0, r2, r1
    lsls r0, r0, #0x10
    lsrs r0, r0, #0x10
    ...
    b lbl_0804f65c
    .align 2, 0
lbl_0804f604: .4byte 0x030013ba
lbl_0804f608: .4byte 0x030013b8
lbl_0804f60c:
    ldrb r0, [r6]
    movs r1, #0xfd
    ands r1, r0
    ...
    cmp r0, #0xd
    bhi lbl_0804f65e
    ldr r1, lbl_0804f630 @ =0x030013d4
    ldrh r0, [r1, #0x14]
    subs r0, #0x48
    lsls r0, r0, #0x10
    lsrs r5, r0, #0x10
...
load_beam_graphics: @ 0x0804f670
    push {lr}
    ldr r1, lbl_0804f6b8 @ =0x03001530
    ldrb r0, [r1, #0x12]
    cmp r0, #2
    bne lbl_0804f6e8
...
call_load_beam_graphics_and_clear_projectiles: @ 0x0804f920
    ...
    cmp r0, #0
    bne lbl_0804f948
    ldr r0, lbl_0804f950 @ =0x03000a2c
    movs r2, #0xe0
    lsls r2, r2, #1
    adds r1, r0, r2
    cmp r0, r1
...
lbl_0804f948:
    ...
    bx r0
    .align 2, 0
lbl_0804f94c: .4byte 0x03000bf0
lbl_0804f950: .4byte 0x03000a2c
...
lbl_0804f9e2:
    strh r0, [r4, #0xa]
    ldr r0, lbl_0804fa04 @ =0x030013d4
    ldrh r0, [r0, #0x16]
    lsls r0, r0, #0x10
    asrs r3, r0, #0x10
    asrs r2, r0, #0x13
...
set_projectile_trail: @ 0x0804fc38
    ...
    lsls r1, r1, #0x18
    lsrs r6, r1, #0x18
    ldr r0, lbl_0804fc60 @ =0x03000c77
    ldrb r0, [r0]
    ands r0, r2
    cmp r0, #0
    bne lbl_0804fcd8
...
check_projectile_hit_block: @ 0x0804fd48
    ...
    lsls r2, r2, #0x18
    lsrs r5, r2, #0x18
    ldr r0, lbl_0804fd70 @ =0x03000079
    strb r1, [r0]
    ldrh r3, [r4, #8]
    ldrh r2, [r4, #0xa]
    ldrb r0, [r4, #0x10]
...
check_ProjectileHitSprite: @ 0x0804fd9c
    ...
    push {r5, r6, r7}
    sub sp, #0x30
    ldr r0, lbl_0804fe94 @ =0x03001530
    mov sb, r0
    ldr r2, lbl_0804fe98 @ =0x03000130
    ldrb r0, [r2]
    cmp r0, #0
    beq lbl_0804fe62
    mov r1, sb
    ...
    str r2, [sp, #0x14]
    ldr r6, lbl_0804fea0 @ =0x030001ac
    movs r3, #0xa8
    lsls r3, r3, #3
    adds r0, r6, r3
    cmp r6, r0
...
lbl_0804fe5a:
    adds r6, #0x38
    ldr r0, lbl_0804fea4 @ =0x030006ec
    cmp r6, r0
    blo lbl_0804fdf8
lbl_0804fe62:
    ...
    cmp r6, r0
    bhs lbl_0804febe
    ldr r3, lbl_0804fea8 @ =0x030007f3
    adds r4, r0, #0
lbl_0804fe78:
    ldrh r0, [r6]
    ldr r1, [sp, #0x14]
    ...
    b lbl_0804feb0
    .align 2, 0
lbl_0804fe94: .4byte 0x03001530
lbl_0804fe98: .4byte 0x03000130
lbl_0804fe9c: .4byte 0x00008001
lbl_0804fea0: .4byte 0x030001ac
lbl_0804fea4: .4byte 0x030006ec
lbl_0804fea8: .4byte 0x030007f3
lbl_0804feac:
    adds r1, r2, r3
    movs r0, #0
lbl_0804feb0:
...
lbl_0804fec2:
    movs r2, #0
    ldr r6, lbl_0804ff94 @ =0x030001ac
    movs r3, #0xa8
    lsls r3, r3, #3
    adds r0, r6, r3
    ldr r1, [sp, #0x10]
    ...
    b lbl_08050348
lbl_0804fed8:
    ldr r0, lbl_0804ff98 @ =0x030007f3
    adds r0, r2, r0
    ldrb r0, [r0]
    adds r3, r6, #0
    adds r3, #0x38
...
lbl_0804fef0:
    ...
    movs r2, #0x11
    str r2, [sp, #0x14]
    ldr r3, lbl_0804ff9c @ =0x03000a2c
    mov r8, r3
    movs r0, #0xe0
    lsls r0, r0, #1
    add r0, r8
...
lbl_0804ff88:
    ...
    mov pc, r0
    .align 2, 0
lbl_0804ff94: .4byte 0x030001ac
lbl_0804ff98: .4byte 0x030007f3
lbl_0804ff9c: .4byte 0x03000a2c
...
lbl_0805032c:
    movs r2, #0x1c
    add r8, r2
    ldr r0, lbl_08050368 @ =0x03000bec
    cmp r8, r0
    bhs lbl_08050338
    b lbl_0804ff30
lbl_08050338:
    ...
    lsrs r2, r0, #0x18
    ldr r6, [sp, #0x2c]
    ldr r0, lbl_0805036c @ =0x030006ec
    cmp r6, r0
    bhs lbl_08050348
    b lbl_0804fed8
lbl_08050348:
...
lbl_08050356:
    ...
    bx r0
    .align 2, 0
lbl_08050368: .4byte 0x03000bec
lbl_0805036c: .4byte 0x030006ec
...
lbl_080503bc:
    ...
    cmp r0, #0
    beq lbl_080503f0
    ldr r2, lbl_08050420 @ =0x030013d4
    ldrb r0, [r2, #1]
    cmp r0, #1
    bne lbl_080503f0
    movs r0, #2
...
lbl_0805043e:
    ...
    cmp r0, #0
    beq lbl_08050472
    ldr r2, lbl_080504a8 @ =0x030013d4
    ldrb r0, [r2, #1]
    cmp r0, #1
    bne lbl_08050472
    movs r0, #2
...
lbl_08050534:
    ...
    cmp r0, #0
    beq lbl_08050562
    ldr r2, lbl_08050578 @ =0x030013d4
    ldrb r0, [r2, #1]
    cmp r0, #1
    bne lbl_08050562
    movs r0, #2
...
lbl_0805078a:
    ...
    beq lbl_080507ce
    lsrs r1, r1, #0x18
    ldr r0, lbl_080507c0 @ =0x03000c77
    ldrb r0, [r0]
    ands r0, r1
    cmp r0, #0
    bne lbl_080507c4
...
kraid_start_tumbling_missile: @ 0x08050974
    ...
    strb r1, [r3, #0xe]
    strh r1, [r3, #0xc]
    ldr r1, lbl_080509a8 @ =0x03000738
    ldrh r0, [r3, #0xa]
    ldrh r1, [r1, #4]
    cmp r0, r1
    bls lbl_080509ac
...
ProjectileProcessNormalBeam: @ 0x08050b64
    ...
    cmp r0, #2
    bne lbl_08050b8c
    ldr r0, lbl_08050b88 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_08050c3c
    .align 2, 0
lbl_08050b88: .4byte 0x03000079
lbl_08050b8c:
    cmp r0, #1
    bne lbl_08050bc4
    ldr r0, lbl_08050bb0 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
ProjectileProcessLongBeam: @ 0x08050c5c
    ...
    cmp r0, #2
    bne lbl_08050c84
    ldr r0, lbl_08050c80 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_08050d34
    .align 2, 0
lbl_08050c80: .4byte 0x03000079
lbl_08050c84:
    cmp r0, #1
    bne lbl_08050cbc
    ldr r0, lbl_08050ca8 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
ProjectileProcessIceBeam: @ 0x08050d48
    ...
    cmp r0, #2
    bne lbl_08050d8c
    ldr r0, lbl_08050d7c @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
lbl_08050d8c:
    cmp r0, #1
    bne lbl_08050dc4
    ldr r0, lbl_08050db0 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
lbl_08050e3c:
    ...
    adds r2, r0, #1
    strb r2, [r4, #0x13]
    ldr r0, lbl_08050e68 @ =0x03001530
    ldrb r0, [r0, #0xd]
    movs r1, #1
    ands r1, r0
    cmp r1, #0
...
lbl_08050ea8:
    ...
    cmp r0, #0
    beq lbl_08050ef8
    ldr r0, lbl_08050ef4 @ =0x03000079
    mov r8, r0
    strb r7, [r0]
    adds r0, r4, #0
    adds r1, r6, #0
...
lbl_08050ee4:
    ...
    b lbl_0805104a
    .align 2, 0
lbl_08050ef4: .4byte 0x03000079
lbl_08050ef8:
    ldr r0, lbl_08050f38 @ =0x03000079
    mov r8, r0
    strb r7, [r0]
    adds r0, r4, #0
    adds r1, r6, #0
...
lbl_08050f3c:
    ...
    cmp r0, #0
    beq lbl_08050f8c
    ldr r0, lbl_08050f88 @ =0x03000079
    mov r8, r0
    strb r7, [r0]
    adds r0, r4, #0
    adds r1, r6, #0
...
lbl_08050f78:
    ...
    b lbl_0805104a
    .align 2, 0
lbl_08050f88: .4byte 0x03000079
lbl_08050f8c:
    ldr r0, lbl_08050fcc @ =0x03000079
    mov r8, r0
    strb r7, [r0]
    adds r0, r4, #0
    adds r1, r6, #0
...
lbl_08050fbe:
    ...
    b lbl_0805104a
    .align 2, 0
lbl_08050fcc: .4byte 0x03000079
lbl_08050fd0:
    ldr r0, lbl_0805100c @ =0x03000079
    mov r8, r0
    strb r7, [r0]
    adds r0, r4, #0
    adds r1, r6, #0
...
lbl_08051000:
    ...
    b lbl_0805104a
    .align 2, 0
lbl_0805100c: .4byte 0x03000079
lbl_08051010:
    ldr r0, lbl_08051064 @ =0x03000079
    mov r8, r0
    strb r7, [r0]
    adds r0, r4, #0
    adds r1, r6, #0
...
ProjectileProcessWaveBeam: @ 0x08051068
    ...
    movs r1, #0x1c
    bl move_projectile
    ldr r0, lbl_0805109c @ =0x03001530
    ldrb r0, [r0, #0xd]
    ands r5, r0
    cmp r5, #0
    beq lbl_08051166
...
lbl_08051166:
    ...
    adds r2, r0, #1
    strb r2, [r4, #0x13]
    ldr r0, lbl_08051194 @ =0x03001530
    ldrb r0, [r0, #0xd]
    movs r1, #1
    ands r1, r0
    cmp r1, #0
...
ProjectileProcessPlasmaBeam: @ 0x08051198
    ...
    cmp r6, #0
    bne lbl_080511d4
    ldr r0, lbl_080511d0 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_08051346
    .align 2, 0
lbl_080511cc: .4byte 0x03001530
lbl_080511d0: .4byte 0x03000079
lbl_080511d4:
    adds r0, r4, #0
    bl check_wave_beam_colliding_with_blocks
lbl_080511da:
    ...
    movs r1, #0x20
    bl move_projectile
    ldr r0, lbl_08051208 @ =0x03001530
    ldrb r0, [r0, #0xd]
    ands r5, r0
    cmp r5, #0
    bne lbl_080511f6
...
lbl_0805132a:
    ...
    adds r2, r0, #1
    strb r2, [r4, #0x13]
    ldr r0, lbl_08051350 @ =0x03001530
    ldrb r0, [r0, #0xd]
    movs r1, #1
    ands r1, r0
    cmp r1, #0
...
ProjectileProcessPistol: @ 0x08051354
    ...
    cmp r0, #2
    bne lbl_0805137c
    ldr r0, lbl_08051378 @ =0x03000079
    movs r1, #8
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_0805142c
    .align 2, 0
lbl_08051378: .4byte 0x03000079
lbl_0805137c:
    cmp r0, #1
    bne lbl_080513b4
    ldr r0, lbl_080513a0 @ =0x03000079
    movs r1, #8
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
ProjectileProcessChargedNormalBeam: @ 0x08051440
    ...
    cmp r0, #2
    bne lbl_08051468
    ldr r0, lbl_08051464 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_08051518
    .align 2, 0
lbl_08051464: .4byte 0x03000079
lbl_08051468:
    cmp r0, #1
    bne lbl_080514a0
    ldr r0, lbl_0805148c @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
ProjectileProcessChargedLongBeam: @ 0x08051538
    ...
    cmp r0, #2
    bne lbl_0805156c
    ldr r0, lbl_08051568 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_0805161c
    .align 2, 0
lbl_08051568: .4byte 0x03000079
lbl_0805156c:
    cmp r0, #1
    bne lbl_080515a4
    ldr r0, lbl_08051590 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
ProjectileProcessChargedIceBeam: @ 0x08051630
    ...
    cmp r0, #2
    bne lbl_08051682
    ldr r0, lbl_08051668 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
lbl_08051682:
    cmp r0, #1
    bne lbl_080516bc
    ldr r0, lbl_080516a8 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
lbl_08051734:
    ...
    adds r2, r0, #1
    strb r2, [r4, #0x13]
    ldr r0, lbl_08051760 @ =0x03001530
    ldrb r0, [r0, #0xd]
    movs r1, #1
    ands r1, r0
    cmp r1, #0
...
ProjectileProcessChargedWaveBeam: @ 0x08051764
    ...
    movs r1, #0x1c
    bl move_projectile
    ldr r0, lbl_0805179c @ =0x03001530
    ldrb r0, [r0, #0xd]
    ands r5, r0
    cmp r5, #0
    beq lbl_080517aa
...
lbl_0805186e:
    ...
    adds r2, r0, #1
    strb r2, [r4, #0x13]
    ldr r0, lbl_0805189c @ =0x03001530
    ldrb r0, [r0, #0xd]
    movs r1, #1
    ands r1, r0
    cmp r1, #0
...
ProjectileProcessChargedPlasmaBeam: @ 0x080518a0
    ...
    cmp r6, #0
    bne lbl_080518dc
    ldr r0, lbl_080518d8 @ =0x03000079
    movs r1, #7
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_08051a6c
    .align 2, 0
lbl_080518d4: .4byte 0x03001530
lbl_080518d8: .4byte 0x03000079
lbl_080518dc:
    adds r0, r4, #0
    bl check_wave_beam_colliding_with_blocks
lbl_080518e2:
    ...
    movs r1, #0x20
    bl move_projectile
    ldr r0, lbl_08051914 @ =0x03001530
    ldrb r0, [r0, #0xd]
    ands r5, r0
    cmp r5, #0
    beq lbl_0805192c
...
lbl_08051a50:
    ...
    adds r2, r0, #1
    strb r2, [r4, #0x13]
    ldr r0, lbl_08051a78 @ =0x03001530
    ldrb r0, [r0, #0xd]
    movs r1, #1
    ands r1, r0
    cmp r1, #0
...
ProjectileProcessChargedPistol: @ 0x08051a7c
    ...
    cmp r0, #2
    bne lbl_08051ab0
    ldr r0, lbl_08051aac @ =0x03000079
    movs r1, #8
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
    ...
    b lbl_08051b60
    .align 2, 0
lbl_08051aac: .4byte 0x03000079
lbl_08051ab0:
    cmp r0, #1
    bne lbl_08051ae8
    ldr r0, lbl_08051ad4 @ =0x03000079
    movs r1, #8
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
decrement_missile_counter: @ 0x08051b74
    push {lr}
    adds r3, r0, #0
    ldr r1, lbl_08051ba4 @ =0x03001530
    ldrh r0, [r1, #8]
    cmp r0, #0
    beq lbl_08051b94
    subs r0, #1
    ...
    cmp r0, #0
    bne lbl_08051b94
    ldr r0, lbl_08051ba8 @ =0x03001414
    ldrb r1, [r0, #2]
    movs r2, #1
    eors r1, r2
    strb r1, [r0, #2]
lbl_08051b94:
    ...
    bx r0
    .align 2, 0
lbl_08051ba4: .4byte 0x03001530
lbl_08051ba8: .4byte 0x03001414
...
ProjectileProcessMissile: @ 0x08051bac
    ...
    cmp r0, #2
    bne lbl_08051bec
    ldr r0, lbl_08051be8 @ =0x03000079
    movs r1, #9
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
lbl_08051bda:
    ...
    b lbl_08051cbe
    .align 2, 0
lbl_08051be8: .4byte 0x03000079
lbl_08051bec:
    cmp r0, #1
    bne lbl_08051c24
    ldr r0, lbl_08051c10 @ =0x03000079
    movs r1, #9
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
decrement_super_missile_counter: @ 0x08051cc4
    push {lr}
    adds r3, r0, #0
    ldr r1, lbl_08051cf4 @ =0x03001530
    ldrb r0, [r1, #0xa]
    cmp r0, #0
    beq lbl_08051ce4
    subs r0, #1
    ...
    cmp r0, #0
    bne lbl_08051ce4
    ldr r0, lbl_08051cf8 @ =0x03001414
    ldrb r1, [r0, #2]
    movs r2, #2
    eors r1, r2
    strb r1, [r0, #2]
lbl_08051ce4:
    ...
    bx r0
    .align 2, 0
lbl_08051cf4: .4byte 0x03001530
lbl_08051cf8: .4byte 0x03001414
...
ProjectileProcessSuperMissile: @ 0x08051cfc
    ...
    cmp r0, #2
    bne lbl_08051d3c
    ldr r0, lbl_08051d38 @ =0x03000079
    movs r1, #0xa
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
lbl_08051d2a:
    ...
    b lbl_08051e0e
    .align 2, 0
lbl_08051d38: .4byte 0x03000079
lbl_08051d3c:
    cmp r0, #1
    bne lbl_08051d74
    ldr r0, lbl_08051d60 @ =0x03000079
    movs r1, #0xa
    strb r1, [r0]
    adds r0, r4, #0
    bl sub_0804fa3c
...
morph_ball_launcher_launch_samus: @ 0x08051e14
    ...
    sub sp, #0x10
    adds r5, r0, #0
    ldr r7, lbl_08051ec4 @ =0x030013d4
    ldrh r1, [r7, #0x14]
    ldrh r3, [r7, #0x12]
    ldr r4, lbl_08051ec8 @ =0x03001588
    adds r0, r4, #0
    adds r0, #0x70
    ldrh r0, [r0]
    adds r0, r1, r0
...
lbl_08051eb4:
    ...
    bx r0
    .align 2, 0
lbl_08051ec4: .4byte 0x030013d4
lbl_08051ec8: .4byte 0x03001588
...
check_samus_bomb_bounce: @ 0x08051ecc
    ...
    sub sp, #0x1c
    mov r8, r0
    ldr r0, lbl_08051fc4 @ =0x030013d4
    ldrh r4, [r0, #0x14]
    str r4, [sp, #0x10]
    ldrh r5, [r0, #0x12]
    str r5, [sp, #0x14]
    ...
    bne lbl_08051fe8
lbl_08051f08:
    ldr r0, lbl_08051fc8 @ =0x03001600
    ldrh r0, [r0]
    str r0, [sp, #0x18]
    ldr r3, lbl_08051fcc @ =0x03001588
    adds r0, r3, #0
    adds r0, #0x70
    ldrh r0, [r0]
    ldr r1, [sp, #0x10]
    ...
    lsls r0, r0, #0x10
    lsrs r4, r0, #0x10
    ldr r1, lbl_08051fc4 @ =0x030013d4
    ldrb r0, [r1, #6]
    cmp r0, #0
    bne lbl_08051fe8
    ldr r0, [sp, #0x10]
...
lbl_08051fa8:
    ...
    b lbl_08051fe8
    .align 2, 0
lbl_08051fc4: .4byte 0x030013d4
lbl_08051fc8: .4byte 0x03001600
lbl_08051fcc: .4byte 0x03001588
lbl_08051fd0:
    ldr r6, [sp, #0x18]
    cmp r4, r6
    blo lbl_08051fe0
...
lbl_08052088:
    ...
    cmp r1, #0xf
    bne lbl_080520b4
    ldr r1, lbl_080520b0 @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    subs r0, #8
    ...
    b lbl_080521e8
    .align 2, 0
lbl_080520b0: .4byte 0x03000079
lbl_080520b4:
    cmp r1, #0xe
    bne lbl_080520c8
    ldr r1, lbl_080520c4 @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    adds r0, #0x38
    b lbl_08052136
    .align 2, 0
lbl_080520c4: .4byte 0x03000079
lbl_080520c8:
    cmp r1, #0xd
    bne lbl_080520e4
    ldr r1, lbl_080520e0 @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    subs r0, #8
    ...
    b lbl_080521ea
    .align 2, 0
lbl_080520e0: .4byte 0x03000079
lbl_080520e4:
    cmp r1, #0xc
    bne lbl_08052100
    ldr r1, lbl_080520fc @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    subs r0, #8
    ...
    b lbl_080521ea
    .align 2, 0
lbl_080520fc: .4byte 0x03000079
lbl_08052100:
    cmp r1, #0xb
    bne lbl_08052114
    ldr r1, lbl_08052110 @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    adds r0, #0x38
    b lbl_08052150
    .align 2, 0
lbl_08052110: .4byte 0x03000079
lbl_08052114:
    cmp r1, #0xa
    bne lbl_08052128
    ldr r1, lbl_08052124 @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    adds r0, #0x38
    b lbl_0805216e
    .align 2, 0
lbl_08052124: .4byte 0x03000079
lbl_08052128:
    cmp r1, #9
    bne lbl_08052144
    ldr r1, lbl_08052140 @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    subs r0, #0x48
lbl_08052136:
    ...
    b lbl_080521ea
    .align 2, 0
lbl_08052140: .4byte 0x03000079
lbl_08052144:
    cmp r1, #8
    bne lbl_08052160
    ldr r0, lbl_0805215c @ =0x03000079
    strb r1, [r0]
    ldrh r0, [r4, #8]
    subs r0, #0x48
lbl_08052150:
    ...
    b lbl_080521ea
    .align 2, 0
lbl_0805215c: .4byte 0x03000079
lbl_08052160:
    cmp r1, #7
    bne lbl_080521ea
    ldr r1, lbl_08052178 @ =0x03000079
    movs r0, #8
    strb r0, [r1]
    ldrh r0, [r4, #8]
    subs r0, #0x48
...
lbl_08052208:
    ...
    b lbl_080522fc
lbl_0805220e:
    ldr r1, lbl_08052298 @ =0x03001530
    ldrb r0, [r1, #0xb]
    cmp r0, #0
    beq lbl_0805222a
    subs r0, #1
    ...
    cmp r0, #0
    bne lbl_0805222a
    ldr r0, lbl_0805229c @ =0x03001414
    ldrb r1, [r0, #2]
    movs r2, #4
    eors r1, r2
    strb r1, [r0, #2]
lbl_0805222a:
    ...
    adds r0, #1
    strb r0, [r4, #0x11]
    ldr r3, lbl_080522a8 @ =0x030001ac
    movs r1, #0xa8
    lsls r1, r1, #3
    adds r0, r3, r1
    cmp r3, r0
...
lbl_08052288:
    ...
    lsls r0, r0, #1
    bl SoundPlay
    ldr r1, lbl_080522ac @ =0x03000130
    movs r0, #1
    strb r0, [r1, #0x10]
    b lbl_080522fc
    .align 2, 0
lbl_08052298: .4byte 0x03001530
lbl_0805229c: .4byte 0x03001414
lbl_080522a0: .4byte 0x08326d90
lbl_080522a4: .4byte 0x0000fff0
lbl_080522a8: .4byte 0x030001ac
lbl_080522ac: .4byte 0x03000130
lbl_080522b0:
    ldrb r0, [r4, #0x13]
    subs r0, #1
    strb r0, [r4, #0x13]
...
lbl_080522d8:
    ldr r0, lbl_08052304 @ =0x03000c72
    movs r1, #0
    ldrsh r0, [r0, r1]
    cmp r0, #2
    bne lbl_080522fc

...
lbl_080296fc:
    ...
    thumb_func_start SpacePirateCheckCollidingWithPirateWhenWalking
SpacePirateCheckCollidingWithPirateWhenWalking: @ 0x08029708
    push {r4, r5, r6, r7, lr}
    mov r7, sl
    mov r6, sb
    mov r5, r8
...
lbl_08029b62:
    ...
    thumb_func_start unk_29b68
unk_29b68: @ 0x08029b68
    push {r4, r5, r6, lr}
...
lbl_08029eec: .4byte gCurrentSprite
    ...
    thumb_func_start unk_29ef0
unk_29ef0: @ 0x08029ef0
    push {r4, r5, r6, r7, lr}
    mov r7, sl
    mov r6, sb
    mov r5, r8
...
SpacePirateWalking: @ 0x0802a83c
    ...
    cmp r0, #9
    bne lbl_0802a900
    bl SpacePirateCheckCollidingWithPirateWhenWalking
    lsls r0, r0, #0x18
    lsrs r5, r0, #0x18
    cmp r5, #0
    beq lbl_0802a88c

...
AtomicSmoothMovement: @ 0x0803b944
    ...
    movs r0, #2
    mov sb, r0
    ldr r0, lbl_0803b980 @ =0x03000bec
    ldrh r0, [r0]
    str r0, [sp]
    ldr r0, lbl_0803b984 @ =0x03000bee
    ldrh r0, [r0]
    mov sl, r0
    movs r7, #0
    movs r1, #0
    mov r8, r1
    ldr r0, lbl_0803b988 @ =0x03000738
    ldrh r5, [r0, #2]
    ldrh r6, [r0, #4]
    ldrh r1, [r0]
    movs r0, #0x80
    ...
    b lbl_0803b990
    .align 2, 0
lbl_0803b980: .4byte 0x03000bec
lbl_0803b984: .4byte 0x03000bee
lbl_0803b988: .4byte 0x03000738
lbl_0803b98c:
    adds r4, r6, #0
    subs r4, #0x20
lbl_0803b990:
...
lbl_0803b9b8:
    movs r7, #1
lbl_0803b9ba:
    ldr r0, lbl_0803b9d0 @ =0x03000738
    ldrh r1, [r0]
    movs r0, #0x80
    lsls r0, r0, #3
    ands r0, r1
...
lbl_0803ba0a:
    movs r4, #0
    ldr r2, lbl_0803ba44 @ =0x03000738
    ldrh r1, [r2]
    movs r0, #0x80
    lsls r0, r0, #2
    ands r0, r1
...
AtomicUpdateDirectionToFleeSamus: @ 0x0803bb98
    push {r4, r5, r6, lr}
    ldr r2, lbl_0803bbe4 @ =0x03000738
    ldrh r4, [r2, #2]
    ldrh r6, [r2, #4]
    ldr r0, lbl_0803bbe8 @ =0x030013d4
    ldrh r1, [r0, #0x14]
    subs r1, #0x48
    lsls r1, r1, #0x10
    lsrs r1, r1, #0x10
    ...
    b lbl_0803bbf6
    .align 2, 0
lbl_0803bbe4: .4byte 0x03000738
lbl_0803bbe8: .4byte 0x030013d4
...
AtomicCheckShootElectricity: @ 0x0803bc34
    push {r4, r5, lr}
    sub sp, #0xc
    ldr r0, lbl_0803bc7c @ =0x03000738
    mov ip, r0
    ldrh r0, [r0, #0x12]
    cmp r0, #0
    beq lbl_0803bc80
...
AtomicInit: @ 0x0803bcec
    push {r4, lr}
    ldr r0, lbl_0803bcfc @ =0x0300002c
    ldrb r1, [r0]
    cmp r1, #0
    bne lbl_0803bd04
    ldr r0, lbl_0803bd00 @ =0x03000738
    strh r1, [r0]
    b lbl_0803bd60
    .align 2, 0
lbl_0803bcfc: .4byte 0x0300002c
lbl_0803bd00: .4byte 0x03000738
lbl_0803bd04:
    ldr r0, lbl_0803bd68 @ =0x03000738
    mov ip, r0
    adds r0, #0x27
    movs r3, #0
    movs r1, #0xc
    ...
    ldrh r0, [r4, #4]
    strh r0, [r4, #8]
    ldr r0, lbl_0803bd78 @ =0x0300083c
    ldrb r0, [r0]
    lsls r0, r0, #4
    strh r0, [r4, #0x12]
lbl_0803bd60:
...
AtomicIdleInit: @ 0x0803bd7c
    ...
    bx lr
    .align 2, 0
lbl_0803bda0: .4byte 0x03000738
lbl_0803bda4: .4byte 0x082f7998

    thumb_func_start AtomicIdle
AtomicIdle: @ 0x0803bda8
    push {r4, r5, r6, lr}
    ldr r0, lbl_0803bdbc @ =0x03001414
    ldrb r0, [r0, #5]
    cmp r0, #0x3f
    bls lbl_0803bdc4
    ldr r0, lbl_0803bdc0 @ =0x03000738
    adds r0, #0x24
    movs r1, #0x26
    strb r1, [r0]
    b lbl_0803be20
    .align 2, 0
lbl_0803bdbc: .4byte 0x03001414
lbl_0803bdc0: .4byte 0x03000738
lbl_0803bdc4:
    ldr r3, lbl_0803be28 @ =0x03000738
    movs r0, #0x2f
    adds r0, r0, r3
    mov ip, r0
    ldrb r2, [r0]
...
AtomicMove: @ 0x0803be38
    ...
    mov r7, r8
    push {r7}
    ldr r0, lbl_0803be50 @ =0x03001414
    ldrb r0, [r0, #5]
    cmp r0, #0x3f
    bls lbl_0803be58
    ldr r0, lbl_0803be54 @ =0x03000738
    adds r0, #0x24
    movs r1, #0x26
    strb r1, [r0]
    b lbl_0803bf70
    .align 2, 0
lbl_0803be50: .4byte 0x03001414
lbl_0803be54: .4byte 0x03000738
lbl_0803be58:
    ldr r3, lbl_0803be78 @ =0x03000738
    ldrh r7, [r3, #2]
    ldrh r6, [r3, #4]
    adds r1, r3, #0
    adds r1, #0x2c
...
lbl_0803be7c:
    ...
    strb r0, [r1]
lbl_0803be92:
    ldr r4, lbl_0803bec4 @ =0x03000738
    adds r0, r4, #0
    adds r0, #0x2f
    ldrb r5, [r0]
    ldrh r1, [r4]
    ...
    ldr r0, lbl_0803bec8 @ =0x030007f1
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0803becc
    ldrh r0, [r4, #2]
    ...
    b lbl_0803bf00
    .align 2, 0
lbl_0803bec4: .4byte 0x03000738
lbl_0803bec8: .4byte 0x030007f1
lbl_0803becc:
    ldrh r1, [r4]
...
lbl_0803bed8:
    ...
    adds r1, r6, #0
    bl SpriteUtilCheckCollisionAtPosition
    ldr r0, lbl_0803bef4 @ =0x030007f1
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0803bef8
    ldrh r0, [r4, #2]
...
lbl_0803befe:
    strh r0, [r4]
lbl_0803bf00:
    ldr r4, lbl_0803bf2c @ =0x03000738
    ldrh r1, [r4]
    movs r0, #0x80
    lsls r0, r0, #2
    mov r8, r0
    ...
    adds r0, r7, #0
    bl SpriteUtilCheckCollisionAtPosition
    ldr r0, lbl_0803bf30 @ =0x030007f1
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0803bf34
    ldrh r0, [r4, #4]
    ...
    b lbl_0803bf68
    .align 2, 0
lbl_0803bf2c: .4byte 0x03000738
lbl_0803bf30: .4byte 0x030007f1
lbl_0803bf34:
    ldrh r1, [r4]
...
lbl_0803bf40:
    ...
    adds r0, r7, #0
    bl SpriteUtilCheckCollisionAtPosition
    ldr r0, lbl_0803bf5c @ =0x030007f1
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0803bf60
    ldrh r0, [r4, #4]
...
AtomicMoveBackToIdle: @ 0x0803bf7c
    ...
    mov r5, r8
    push {r5, r6, r7}
    ldr r0, lbl_0803bf98 @ =0x03001414
    ldrb r0, [r0, #5]
    cmp r0, #0x3f
    bls lbl_0803bfa0
    ldr r0, lbl_0803bf9c @ =0x03000738
    adds r0, #0x24
    movs r1, #0x26
    strb r1, [r0]
    b lbl_0803c0d8
    .align 2, 0
lbl_0803bf98: .4byte 0x03001414
lbl_0803bf9c: .4byte 0x03000738
lbl_0803bfa0:
    ldr r0, lbl_0803bfcc @ =0x0000fffc
    mov r8, r0
    ldr r0, lbl_0803bfd0 @ =0x03000738
    ldrh r1, [r0, #6]
    mov sb, r1
    ldrh r5, [r0, #8]
    ldrh r7, [r0, #2]
...
lbl_0803c014:
    movs r5, #2
    ldr r4, lbl_0803c03c @ =0x03000738
    ldrh r1, [r4]
    movs r0, #0x80
    lsls r0, r0, #3
    ands r0, r1
    ...
    adds r1, r6, #0
    bl SpriteUtilCheckCollisionAtPosition
    ldr r0, lbl_0803c040 @ =0x030007f1
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0803c05c
    ldrh r0, [r4, #2]
    ...
    b lbl_0803c05a
    .align 2, 0
lbl_0803c03c: .4byte 0x03000738
lbl_0803c040: .4byte 0x030007f1
lbl_0803c044:
    adds r0, r7, #0
    subs r0, #0x20
    adds r1, r6, #0
    bl SpriteUtilCheckCollisionAtPosition
    ldr r0, lbl_0803c084 @ =0x030007f1
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0803c05c
    ldrh r0, [r4, #2]
...
lbl_0803c05a:
    strh r0, [r4, #2]
lbl_0803c05c:
    ldr r4, lbl_0803c088 @ =0x03000738
    ldrh r1, [r4]
    movs r0, #0x80
    lsls r0, r0, #2
    ands r0, r1
    ...
    b lbl_0803c0a2
    .align 2, 0
lbl_0803c084: .4byte 0x030007f1
lbl_0803c088: .4byte 0x03000738
lbl_0803c08c:
    adds r1, r6, #0
    subs r1, #0x20
    adds r0, r7, #0
    bl SpriteUtilCheckCollisionAtPosition
    ldr r0, lbl_0803c0c8 @ =0x030007f1
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_0803c0a4
    ldrh r0, [r4, #4]
...
lbl_0803c0a2:
    strh r0, [r4, #4]
lbl_0803c0a4:
    ldr r1, lbl_0803c0cc @ =0x03000738
    ldrh r0, [r1, #2]
    mov r3, r8
    ands r0, r3
    mov r2, sb
    ...
    b lbl_0803c0d8
    .align 2, 0
lbl_0803c0c8: .4byte 0x030007f1
lbl_0803c0cc: .4byte 0x03000738
lbl_0803c0d0:
    bl AtomicUpdateDirectionToFleeSamus
    bl AtomicCheckShootElectricity
lbl_0803c0d8:
...
AtomicChasingSamusInit: @ 0x0803c0e8
    ldr r3, lbl_0803c114 @ =0x03000738
    adds r2, r3, #0
    adds r2, #0x24
    movs r1, #0
    movs r0, #0x27
    ...
    bx lr
    .align 2, 0
lbl_0803c114: .4byte 0x03000738

    thumb_func_start AtomicChasingSamus
AtomicChasingSamus: @ 0x0803c118
    push {lr}
    ldr r0, lbl_0803c140 @ =0x03001414
    ldrb r0, [r0, #5]
    cmp r0, #0
    bne lbl_0803c148
    ldr r2, lbl_0803c144 @ =0x03000738
    adds r1, r2, #0
    adds r1, #0x24
    movs r0, #8
    strb r0, [r1]
    ...
    b lbl_0803c14c
    .align 2, 0
lbl_0803c140: .4byte 0x03001414
lbl_0803c144: .4byte 0x03000738
lbl_0803c148:
...
AtomicElectricityCheckAtomicDead: @ 0x0803c150
    ...
    lsls r0, r0, #0x18
    lsrs r0, r0, #0x18
    ldr r2, lbl_0803c174 @ =0x030001ac
    lsls r1, r0, #3
    subs r1, r1, r0
    lsls r1, r1, #3
    adds r2, r1, r2
...
AtomicElectriciytInit: @ 0x0803c180
    push {r4, r5, lr}
    ldr r4, lbl_0803c19c @ =0x03000738
    adds r0, r4, #0
    adds r0, #0x23
    ldrb r0, [r0]
...
AtomicElectricitySpawn: @ 0x0803c1fc
    push {r4, r5, r6, r7, lr}
    ldr r4, lbl_0803c21c @ =0x03000738
    adds r0, r4, #0
    adds r0, #0x23
    ldrb r5, [r0]
    adds r0, r5, #0
    ...
    b lbl_0803c39c
    .align 2, 0
lbl_0803c21c: .4byte 0x03000738
lbl_0803c220:
    ldr r1, lbl_0803c288 @ =0x030001ac
    lsls r0, r5, #3
    subs r0, r0, r5
    lsls r0, r0, #3
    adds r0, r0, r1
...
lbl_0803c24c:
    ...
    ldrh r3, [r4, #2]
    ldrh r6, [r4, #4]
    ldr r1, lbl_0803c290 @ =0x030013d4
    ldrh r0, [r1, #0x14]
    subs r0, #0x48
    lsls r0, r0, #0x10
    lsrs r2, r0, #0x10
...
lbl_0803c27a:
    ...
    b lbl_0803c29a
    .align 2, 0
lbl_0803c288: .4byte 0x030001ac
lbl_0803c28c: .4byte 0x00000261
lbl_0803c290: .4byte 0x030013d4
lbl_0803c294:
    ldrh r0, [r4]
    movs r7, #0x80
    lsls r7, r7, #3
lbl_0803c29a:
    ...
    cmp r0, r2
    bge lbl_0803c2f4
    ldr r2, lbl_0803c2dc @ =0x03000738
...
lbl_0803c2f4:
    ...
    cmp r0, r5
    bge lbl_0803c348
    ldr r2, lbl_0803c330 @ =0x03000738
...
lbl_0803c348:
    ldr r1, lbl_0803c36c @ =0x03000738
...
AtomicElectricityMove: @ 0x0803c3a8
    push {r4, r5, lr}
    movs r3, #0x14
    ldr r2, lbl_0803c3d0 @ =0x03000738
    adds r0, r2, #0
    adds r0, #0x2d
    ldrb r1, [r0]
    movs r0, #1
...
lbl_0803c3fe:
    ...
    cmp r0, #0
    beq lbl_0803c462
    ldr r0, lbl_0803c44c @ =0x03000088
    ldrb r1, [r0, #0xc]
    movs r0, #3
    ands r0, r1
    adds r1, r4, #0
...
AtomicElectricityExploding: @ 0x0803c470
    push {r4, lr}
    ldr r4, lbl_0803c4b8 @ =0x03000738
    ldrh r0, [r4, #0x16]
    cmp r0, #3
    bhi lbl_0803c482
    adds r1, r4, #0
...
AtomicElectricityCheckOnGroundAnimEnded: @ 0x0803c4c4
    ...
    cmp r0, #0
    beq lbl_0803c4d4
    ldr r1, lbl_0803c4d8 @ =0x03000738
    movs r0, #0
    strh r0, [r1]
lbl_0803c4d4:
    pop {r0}
    bx r0
    .align 2, 0
lbl_0803c4d8: .4byte 0x03000738

    thumb_func_start Atomic
Atomic: @ 0x0803c4dc
    push {r4, lr}
    sub sp, #4
    ldr r1, lbl_0803c51c @ =0x03000738
    adds r3, r1, #0
    adds r3, #0x32
    ldrb r2, [r3]
    movs r4, #2
    ...
    bl SoundPlayNotAlreadyPlaying
lbl_0803c508:
    ldr r4, lbl_0803c51c @ =0x03000738
    adds r0, r4, #0
    adds r0, #0x30
    ldrb r0, [r0]
    cmp r0, #0
...
lbl_0803c606:
    ...
    b lbl_0803c61e
lbl_0803c60c:
    ldr r0, lbl_0803c628 @ =0x03000738
    ldrh r1, [r0, #2]
    ldrh r2, [r0, #4]
    movs r0, #0x20
    str r0, [sp]

...
enter_tourian_anim: @ 0x08067080
    push {r4, r5, r6, lr}
    ldr r0, lbl_08067098 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    ldrb r0, [r0, #4]
    cmp r0, #9
    bls lbl_0806708e
...
lbl_0806708e:
    ...
    mov pc, r0
    .align 2, 0
lbl_08067098: .4byte sNonGameplayRamPointer
...
lbl_080670e0:
    ldr r5, lbl_080670fc @ =sNonGameplayRamPointer
    ldr r1, [r5]
    ldrb r4, [r1, #0xa]
    cmp r4, #0
    bne lbl_08067100
    ...
    b lbl_080672dc
    .align 2, 0
lbl_080670fc: .4byte sNonGameplayRamPointer
lbl_08067100:
    movs r0, #0
    strh r0, [r1, #2]
    b lbl_080672fe
lbl_08067106:
    ldr r0, lbl_08067128 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    adds r0, r2, #0
    adds r0, #0xa8
    ldrb r1, [r0]
...
lbl_0806711a:
    ...
    b lbl_080672fe
    .align 2, 0
lbl_08067128: .4byte sNonGameplayRamPointer
lbl_0806712c:
    ldr r4, lbl_0806714c @ =sNonGameplayRamPointer
    ldr r1, [r4]
    ldrh r0, [r1, #2]
    cmp r0, #8
    bne lbl_08067158
    ...
    b lbl_080672fe
    .align 2, 0
lbl_0806714c: .4byte sNonGameplayRamPointer
...
lbl_080671b8:
    ldr r3, lbl_080671dc @ =sNonGameplayRamPointer
    ldr r2, [r3]
    ldrh r1, [r2, #2]
    movs r0, #0x96
    lsls r0, r0, #1
...
lbl_080671c8:
    ...
    b lbl_080672dc
    .align 2, 0
lbl_080671dc: .4byte sNonGameplayRamPointer
lbl_080671e0:
    ldr r4, lbl_08067214 @ =sNonGameplayRamPointer
    ldr r2, [r4]
...
lbl_080671fe:
    ...
    b lbl_080672dc
    .align 2, 0
lbl_08067214: .4byte sNonGameplayRamPointer
lbl_08067218: .4byte 0x0000011b
lbl_0806721c: .4byte 0x0000011d
lbl_08067220:
    ldr r4, lbl_08067234 @ =sNonGameplayRamPointer
    ldr r0, [r4]
    ldrh r0, [r0, #2]
    cmp r0, #0x3c
    bls lbl_080672fe
    ...
    b lbl_080672d8
    .align 2, 0
lbl_08067234: .4byte sNonGameplayRamPointer
...
lbl_0806723c:
    ...
    ldr r0, lbl_080672a8 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    movs r0, #0
    strh r0, [r1, #2]
    ldrb r0, [r1, #4]
    ...
    strb r0, [r1, #4]
lbl_08067266:
    ldr r3, lbl_080672a8 @ =sNonGameplayRamPointer
    ldr r1, [r3]
...
lbl_080672a8: .4byte sNonGameplayRamPointer
...
lbl_080672b0:
    ...
    subs r4, r0, r1
lbl_080672b6:
    ldr r0, lbl_080672c8 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    movs r0, #0x88
    lsls r0, r0, #1
    adds r1, r1, r0
    ...
    b lbl_080672fe
    .align 2, 0
lbl_080672c8: .4byte sNonGameplayRamPointer
lbl_080672cc:
    bl unk_61f44
    cmp r0, #0
    beq lbl_080672fe
lbl_080672d4:
    ldr r0, lbl_080672e4 @ =sNonGameplayRamPointer
    ldr r1, [r0]
lbl_080672d8:
    movs r0, #0
    strh r0, [r1, #2]
lbl_080672dc:
    ...
    b lbl_080672fe
    .align 2, 0
lbl_080672e4: .4byte sNonGameplayRamPointer
lbl_080672e8:
    bl unk_61f0c
    ldr r3, lbl_0806733c @ =sNonGameplayRamPointer
    ldr r1, [r3]
    ldrb r0, [r1]
    adds r0, #1
    movs r2, #0
...
lbl_080672fe:
    bl sub_08067390
    movs r4, #1
    ldr r6, lbl_0806733c @ =sNonGameplayRamPointer
    movs r5, #0x88
    lsls r5, r5, #1
lbl_0806730a:
    ldr r0, [r6]
    ...
    movs r3, #0
    movs r4, #1
    ldr r2, lbl_0806733c @ =sNonGameplayRamPointer
    ldr r0, [r2]
    ...
    b lbl_08067358
    .align 2, 0
lbl_0806733c: .4byte sNonGameplayRamPointer
...
sub_08067390: @ 0x08067390
    push {r4, lr}
    ldr r4, lbl_080673d8 @ =sNonGameplayRamPointer
    ldr r0, [r4]
    ldrb r0, [r0, #0xa]
    cmp r0, #0
    beq lbl_080673d2
...
lbl_080673d2:
    ...
    bx r0
    .align 2, 0
lbl_080673d8: .4byte sNonGameplayRamPointer
...
enter_tourian_init: @ 0x0806794c
    ...
    adds r2, r4, #0
    bl CutsceneSetBackgroundPosition
    ldr r2, lbl_08067cdc @ =sNonGameplayRamPointer
    ldr r0, [r2]
    movs r3, #0x8d
    lsls r3, r3, #1
    adds r1, r0, r3
...
lbl_08067cdc: .4byte sNonGameplayRamPointer
...
enter_tourian_subroutine: @ 0x08067d0c
    ...
    ldr r0, lbl_08067d3c @ =sNonGameplayRamPointer
    ldr r0, [r0]
    ldrb r0, [r0]
    lsls r0, r0, #3
    adds r0, r0, r1
...
lbl_08067d3c: .4byte sNonGameplayRamPointer
...
sub_08067d40: @ 0x08067d40
    ...
    ldr r0, lbl_08067d7c @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrb r0, [r1]
    lsls r0, r0, #3
    adds r0, r0, r2
...
lbl_08067d7c: .4byte sNonGameplayRamPointer
...
samus_in_blue_ship_powering_up: @ 0x08067d8c
    push {r4, lr}
    ldr r0, lbl_08067da4 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    ldrb r0, [r0, #4]
    cmp r0, #5
    bhi lbl_08067e66
    ...
    mov pc, r0
    .align 2, 0
lbl_08067da4: .4byte sNonGameplayRamPointer
...
lbl_08067dc4:
    ...
    cmp r0, #0
    beq lbl_08067e66
    ldr r0, lbl_08067dd4 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    b lbl_08067e3e
    .align 2, 0
lbl_08067dd4: .4byte sNonGameplayRamPointer
lbl_08067dd8:
    ldr r3, lbl_08067df0 @ =sNonGameplayRamPointer
    ldr r1, [r3]
    ldrh r0, [r1, #2]
    cmp r0, #0x1e
    bls lbl_08067e66
    ...
    b lbl_08067e42
    .align 2, 0
lbl_08067df0: .4byte sNonGameplayRamPointer
lbl_08067df4:
    ldr r0, lbl_08067e04 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    adds r0, r1, #0
    adds r0, #0xfd
    ldrb r0, [r0]
    ...
    b lbl_08067e3e
    .align 2, 0
lbl_08067e04: .4byte sNonGameplayRamPointer
lbl_08067e08:
    ldr r4, lbl_08067e30 @ =sNonGameplayRamPointer
    ldr r0, [r4]
    ldrh r0, [r0, #2]
    cmp r0, #0x1e
    bls lbl_08067e66
    ...
    b lbl_08067e42
    .align 2, 0
lbl_08067e30: .4byte sNonGameplayRamPointer
lbl_08067e34:
    ldr r0, lbl_08067e4c @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrh r0, [r1, #2]
    cmp r0, #0x5a
    bls lbl_08067e66
...
lbl_08067e42:
    ...
    b lbl_08067e66
    .align 2, 0
lbl_08067e4c: .4byte sNonGameplayRamPointer
lbl_08067e50:
    bl unk_61f0c
    ldr r3, lbl_08067e80 @ =sNonGameplayRamPointer
    ldr r1, [r3]
    ldrb r0, [r1]
    adds r0, #1
    movs r2, #0
    ...
    strh r2, [r0, #2]
lbl_08067e66:
    ldr r4, lbl_08067e80 @ =sNonGameplayRamPointer
    ldr r0, [r4]
    adds r0, #0xc0
    bl sub_08067e84
    ldr r0, [r4]
    ...
    bx r1
    .align 2, 0
lbl_08067e80: .4byte sNonGameplayRamPointer
...
samus_in_blue_ship_init: @ 0x08067f90
    ...
    bl CutsceneSetBGCNTPageData
    bl CutsceneReset
    ldr r4, lbl_080680ac @ =sNonGameplayRamPointer
    ldr r1, [r4]
    movs r6, #0
...
lbl_080680ac: .4byte sNonGameplayRamPointer
...
samus_in_blue_ship_subroutine: @ 0x080680bc
    ...
    ldr r0, lbl_080680ec @ =sNonGameplayRamPointer
    ldr r0, [r0]
    ldrb r0, [r0]
    lsls r0, r0, #3
    adds r0, r0, r1
...
lbl_080680ec: .4byte sNonGameplayRamPointer
...
sub_080680f0: @ 0x080680f0
    ...
    ldr r0, lbl_08068120 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrb r0, [r1]
    lsls r0, r0, #3
    adds r0, r0, r2
...
lbl_08068120: .4byte sNonGameplayRamPointer
...
count_tanks_in_area: @ 0x0806cef8
    push {r4, r5, lr}
    ldr r1, lbl_0806cf3c @ =sNonGameplayRamPointer
    ldr r0, [r1]
    adds r0, #0x36
    movs r2, #0
    strb r2, [r0]
    ...
    b lbl_0806cfd8
    .align 2, 0
lbl_0806cf3c: .4byte sNonGameplayRamPointer
...
lbl_0806d076:
    cmp r0, #0
    beq lbl_0806d0a0
    ldr r0, lbl_0806d090 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r1, r0, #0
    adds r1, #0x34
    ldrb r0, [r1]
    ...
    b lbl_0806d0aa
    .align 2, 0
lbl_0806d090: .4byte sNonGameplayRamPointer
lbl_0806d094:
    cmp r0, #2
    beq lbl_0806d09a
    b lbl_0806d324
lbl_0806d09a:
    ...
    b lbl_0806d0aa
lbl_0806d0a0:
    ldr r0, lbl_0806d1d4 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r0, #0x34
    movs r1, #2
    strb r1, [r0]
lbl_0806d0aa:
    ...
    movs r3, #0x20
    bl DMATransfer
    ldr r1, lbl_0806d1d4 @ =sNonGameplayRamPointer
    mov r8, r1
    ldr r0, [r1]
    adds r0, #0x36
    ldrb r4, [r0]
...
lbl_0806d2d8:
    ...
    b lbl_0806d31c
    .align 2, 0
lbl_0806d2fc: .4byte sNonGameplayRamPointer
...
sub_0806d334: @ 0x0806d334
    push {r4, r5, r6, lr}
    sub sp, #4
    ldr r2, lbl_0806d374 @ =sNonGameplayRamPointer
    ldr r0, [r2]
    adds r0, #0x4c
    movs r1, #0
    strb r1, [r0]
    ...
    b lbl_0806d3c6
    .align 2, 0
lbl_0806d374: .4byte sNonGameplayRamPointer
...
lbl_0806d3ae:
    ...
    ble lbl_0806d3ae
lbl_0806d3c6:
    ldr r2, lbl_0806d430 @ =sNonGameplayRamPointer
    ldr r0, [r2]
    adds r0, #0x4d
    movs r1, #0
    strb r1, [r0]
...
lbl_0806d430: .4byte sNonGameplayRamPointer
...
sub_0806d448: @ 0x0806d448
    push {lr}
    movs r1, #0
    ldr r0, lbl_0806d460 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r0, #0x4c
    ldrb r0, [r0]
    cmp r0, #0
    ...
    b lbl_0806d476
    .align 2, 0
lbl_0806d460: .4byte sNonGameplayRamPointer
lbl_0806d464:
    cmp r0, #1
    bne lbl_0806d46e
    bl sub_0806d480
...
sub_0806d480: @ 0x0806d480
    push {r4, r5, r6, r7, lr}
    ldr r3, lbl_0806d494 @ =sNonGameplayRamPointer
    ldr r1, [r3]
    adds r0, r1, #0
    adds r0, #0x4f
    ldrb r0, [r0]
    ...
    b lbl_0806d516
    .align 2, 0
lbl_0806d494: .4byte sNonGameplayRamPointer
lbl_0806d498:
    adds r1, #0x4d
    ldrb r0, [r1]
    adds r0, #1
...
sub_0806d528: @ 0x0806d528
    push {r4, r5, r6, r7, lr}
    movs r6, #0
    ldr r5, lbl_0806d550 @ =sNonGameplayRamPointer
    ldr r1, [r5]
    adds r1, #0x4d
    ldrb r0, [r1]
    adds r0, #1
    ...
    b lbl_0806d676
    .align 2, 0
lbl_0806d550: .4byte sNonGameplayRamPointer
lbl_0806d554:
    cmp r0, #2
    beq lbl_0806d640
    cmp r0, #3
...
sub_0806d680: @ 0x0806d680
    ...
    movs r0, #0
    str r0, [sp]
    ldr r2, lbl_0806d6b4 @ =sNonGameplayRamPointer
    ldr r1, [r2]
    adds r1, #0x4d
    ldrb r0, [r1]
    adds r0, #1
...
lbl_0806d6aa:
    ...
    mov pc, r0
    .align 2, 0
lbl_0806d6b4: .4byte sNonGameplayRamPointer
...
lbl_0806da50:
    ...
    cmp r6, #0
    bgt lbl_0806da50
    ldr r3, lbl_0806da78 @ =sNonGameplayRamPointer
    ldr r1, [r3]
    adds r1, #0x4e
    ldrb r0, [r1]
    adds r0, #1
...
lbl_0806da78: .4byte sNonGameplayRamPointer
lbl_0806da7c:
    mov r2, ip
    ldr r0, [r2]
    movs r4, #0x99
...
sub_0806db58: @ 0x0806db58
    ...
    lsrs r4, r0, #0x18
    adds r6, r4, #0
    ldr r5, lbl_0806dc14 @ =sNonGameplayRamPointer
    ldr r0, [r5]
    adds r0, #0x2e
    movs r2, #0
    strb r2, [r0]
...
lbl_0806dbd6:
    ...
    b lbl_0806dcc0
    .align 2, 0
lbl_0806dc14: .4byte sNonGameplayRamPointer
lbl_0806dc18:
    cmp r6, #2
    bne lbl_0806dc52
    ldr r2, [r5]
...
lbl_0806dc9c:
    adds r2, r6, #6
    subs r5, r6, #6
    ldr r1, lbl_0806dcb4 @ =sNonGameplayRamPointer
    ldr r0, [r1]
    ldrb r0, [r0, #0x13]
    adds r7, r1, #0
    cmp r2, r0
    ...
    b lbl_0806dcc0
    .align 2, 0
lbl_0806dcb4: .4byte sNonGameplayRamPointer
lbl_0806dcb8:
    cmp r5, r0
    ble lbl_0806dcc0
    subs r0, r5, r0
...
sub_0806ddc0: @ 0x0806ddc0
    push {r4, r5, r6, r7, lr}
    ldr r4, lbl_0806de00 @ =sNonGameplayRamPointer
    ldr r2, [r4]
    ldrb r0, [r2, #0x12]
    movs r1, #7
    cmp r0, #6
...
lbl_0806ddf0:
    ...
    b lbl_0806de0c
    .align 2, 0
lbl_0806de00: .4byte sNonGameplayRamPointer
lbl_0806de04:
    adds r2, #2
    adds r1, #1
    cmp r1, #0x1f
...
lbl_0806de16:
    ...
    lsls r0, r0, #1
    mov ip, r0
    ldr r7, lbl_0806de3c @ =sNonGameplayRamPointer
lbl_0806de22:
    movs r1, #0
    subs r4, r3, #1
    lsls r0, r3, #6
...
lbl_0806de2a:
    ...
    b lbl_0806de48
    .align 2, 0
lbl_0806de3c: .4byte sNonGameplayRamPointer
lbl_0806de40:
    adds r2, #2
    adds r1, #1
    cmp r1, #0x1f
...
lbl_0806de52:
    ...
    lsls r0, r0, #1
    mov ip, r0
    ldr r7, lbl_0806de78 @ =sNonGameplayRamPointer
lbl_0806de5e:
    movs r1, #0
    adds r4, r3, #1
    lsls r0, r3, #1
...
lbl_0806de66:
    ...
    b lbl_0806de84
    .align 2, 0
lbl_0806de78: .4byte sNonGameplayRamPointer
lbl_0806de7c:
    adds r2, #0x40
    adds r1, #1
    cmp r1, #0x1f
...
lbl_0806de8e:
    ...
    lsls r0, r0, #1
    mov ip, r0
    ldr r7, lbl_0806deb4 @ =sNonGameplayRamPointer
lbl_0806de9a:
    movs r1, #0
    subs r4, r3, #1
    lsls r0, r3, #1
...
lbl_0806dea2:
    ...
    b lbl_0806dec0
    .align 2, 0
lbl_0806deb4: .4byte sNonGameplayRamPointer
lbl_0806deb8:
    adds r2, #0x40
    adds r1, #1
    cmp r1, #0x1f
...
sub_0806ded0: @ 0x0806ded0
    push {r4, r5, r6, r7, lr}
    ldr r1, lbl_0806defc @ =sNonGameplayRamPointer
    ldr r0, [r1]
    movs r2, #0xba
    lsls r2, r2, #2
    adds r4, r0, r2
...
lbl_0806dee2:
    ...
    b lbl_0806df12
    .align 2, 0
lbl_0806defc: .4byte sNonGameplayRamPointer
...
lbl_0806df98:
    ...
    mov sb, r1
lbl_0806df9e:
    ldr r3, lbl_0806dff0 @ =sNonGameplayRamPointer
    ldr r0, [r3]
    movs r2, #0x82
    lsls r2, r2, #1
    adds r0, r0, r2
...
check_explored_areas: @ 0x0806dffc
    push {r4, r5, r6, r7, lr}
    ldr r0, lbl_0806e030 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    adds r1, #0xb8
    movs r2, #0
    strb r2, [r1]
...
lbl_0806e01a:
    ...
    b lbl_0806e040
    .align 2, 0
lbl_0806e030: .4byte sNonGameplayRamPointer
...
map_screen_check_input: @ 0x0806e04c
    push {r4, r5, r6, lr}
    ldr r0, lbl_0806e064 @ =sNonGameplayRamPointer
    ldr r3, [r0]
    adds r1, r3, #0
    adds r1, #0xb4
    ldrb r1, [r1]
    ...
    b lbl_0806e1ea
    .align 2, 0
lbl_0806e064: .4byte sNonGameplayRamPointer
lbl_0806e068:
    movs r4, #0
...
lbl_0806e18c:
    ...
    beq lbl_0806e1a6
lbl_0806e190:
    ldr r0, lbl_0806e1c0 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    movs r2, #0
    movs r0, #0
    strh r0, [r1, #0xa]
...
lbl_0806e1c0: .4byte sNonGameplayRamPointer
...
lbl_0806e1c8:
    ...
    cmp r0, #0
    beq lbl_0806e1ea
    ldr r0, lbl_0806e1f0 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    adds r0, r1, #0
    adds r0, #0xbb
    ldrb r0, [r0]
...
lbl_0806e1ea:
    ...
    bx r0
    .align 2, 0
lbl_0806e1f0: .4byte sNonGameplayRamPointer
...
sub_0806e1f4: @ 0x0806e1f4
    ...
    cmp r5, #0
    bne lbl_0806e210
    ldr r3, lbl_0806e20c @ =sNonGameplayRamPointer
    ldr r2, [r3]
    ldrb r0, [r2, #0x11]
    movs r1, #1
    eors r0, r1
    b lbl_0806e21e
    .align 2, 0
lbl_0806e20c: .4byte sNonGameplayRamPointer
lbl_0806e210:
    ldr r0, lbl_0806e260 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    ldrb r1, [r2, #0x11]
    adds r3, r0, #0
    cmp r1, #0
...
map_screen_change_map: @ 0x0806e2d0
    push {r4, r5, r6, r7, lr}
    sub sp, #4
    ldr r5, lbl_0806e2f0 @ =sNonGameplayRamPointer
    ldr r2, [r5]
    adds r0, r2, #0
    adds r0, #0xb4
    ldrb r4, [r0]
    ...
    b lbl_0806e454
    .align 2, 0
lbl_0806e2f0: .4byte sNonGameplayRamPointer
lbl_0806e2f4:
    cmp r4, #3
    bne lbl_0806e2fa
    b lbl_0806e42c
...
lbl_0806e324:
    cmp r3, #6
    bhi lbl_0806e324
    ldr r6, lbl_0806e394 @ =sNonGameplayRamPointer
...
lbl_0806e394: .4byte sNonGameplayRamPointer
...
lbl_0806e442:
    ...
    movs r1, #1
    bl draw_in_game_time_and_tanks
    ldr r0, lbl_0806e45c @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r0, #0xb4
    movs r1, #0
    strb r1, [r0]
lbl_0806e454:
    ...
    bx r0
    .align 2, 0
lbl_0806e45c: .4byte sNonGameplayRamPointer

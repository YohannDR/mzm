...
sub_08002f00: @ 0x08002f00
    ...
    lsrs r2, r2, #0x10
    mov sb, r2
    ldr r0, lbl_08002f88 @ =unk_03001d00
    ldrb r1, [r0, #1]
    mov sl, r0
    cmp r1, #0
    bne lbl_08003010
    ...
    b lbl_08003000
    .align 2, 0
lbl_08002f88: .4byte unk_03001d00
...
lbl_08003000:
    ...
    strb r0, [r6, #0x1c]
    strb r0, [r5, #0x1c]
    ldr r0, lbl_08003024 @ =unk_03001d00
    mov sl, r0
lbl_0800300a:
    movs r0, #0
    mov r1, sl
...
lbl_08003024: .4byte unk_03001d00
...
sub_08003380: @ 0x08003380
    push {r4, lr}
    ldr r3, lbl_080033c8 @ =unk_03001d00
    ldrb r0, [r3, #0x10]
    adds r0, #1
    strb r0, [r3, #0x10]
    lsls r0, r0, #0x18
...
lbl_080033c0:
    ...
    bx r0
    .align 2, 0
lbl_080033c8: .4byte unk_03001d00
...
sub_080033dc: @ 0x080033dc
    push {r4, r5, lr}
    sub sp, #4
    ldr r5, lbl_08003440 @ =unk_03001d00
    ldrb r4, [r5, #1]
    cmp r4, #0
    bne lbl_08003438
    movs r0, #1
...
lbl_08003438:
    ...
    bx r0
    .align 2, 0
lbl_08003440: .4byte unk_03001d00
...
sub_08003458: @ 0x08003458
    push {r4, r5, lr}
    sub sp, #4
    ldr r5, lbl_08003498 @ =unk_03001d00
    ldrb r4, [r5, #1]
    cmp r4, #0
    bne lbl_08003490
    movs r0, #1
...
lbl_08003490:
    ...
    bx r0
    .align 2, 0
lbl_08003498: .4byte unk_03001d00
...
update_music_track: @ 0x080036d0
    ...
    lsls r0, r0, #0x10
    lsrs r4, r0, #0x10
    ldr r0, lbl_080036fc @ =unk_03001d00
    mov r8, r0
    adds r0, #0x21
    ldrb r1, [r0]
    movs r0, #4
    ...
    b lbl_08003776
    .align 2, 0
lbl_080036fc: .4byte unk_03001d00
lbl_08003700:
    lsls r0, r1, #0x18
    cmp r0, #0
    bne lbl_08003776
...
sub_0800378c: @ 0x0800378c
    ...
    lsls r0, r0, #0x10
    lsrs r5, r0, #0x10
    ldr r7, lbl_08003808 @ =unk_03001d00
    ldrb r6, [r7, #1]
    cmp r6, #0
    bne lbl_08003866
    movs r0, #1
...
lbl_080037d4:
    ...
    b lbl_0800383a
    .align 2, 0
lbl_08003808: .4byte unk_03001d00
...
lbl_0800383a:
    ...
    movs r1, #0x1e
    bl sub_08002c94
    ldr r0, lbl_08003874 @ =unk_03001d00
    strh r5, [r0, #0x22]
lbl_08003860:
    ldr r1, lbl_08003874 @ =unk_03001d00
    movs r0, #0
    strb r0, [r1, #1]
lbl_08003866:
    pop {r4, r5, r6, r7}
...
check_play_new_music_track: @ 0x08003878
    ...
    b lbl_080038c8
    .align 2, 0
lbl_08003898: .4byte unk_03001d00
lbl_0800389c:
    lsls r0, r1, #0x18
    lsrs r5, r0, #0x18
    cmp r5, #0
...
sub_080038d8: @ 0x080038d8
    push {r4, r5, r6, r7, lr}
    ldr r6, lbl_08003924 @ =unk_03001d00
    adds r0, r6, #0
    adds r0, #0x21
    ldrb r1, [r0]
    movs r0, #0x40
    ...
    strh r0, [r6, #0x1c]
lbl_08003918:
    ldr r1, lbl_08003924 @ =unk_03001d00
    movs r0, #0
    strh r0, [r1, #0x22]
    pop {r4, r5, r6, r7}
    pop {r0}
    bx r0
    .align 2, 0
lbl_08003924: .4byte unk_03001d00
...
update_music_after_alarm_disable: @ 0x08003930
    push {lr}
    ldr r1, lbl_08003950 @ =unk_03001d00
    adds r2, r1, #0
    adds r2, #0x21
    movs r0, #0x20
    strb r0, [r2]
    ...
    b lbl_0800397a
    .align 2, 0
lbl_08003950: .4byte unk_03001d00
lbl_08003954:
    subs r0, #0x5a
    lsls r0, r0, #0x10
    lsrs r0, r0, #0x10
...
sub_080039c8: @ 0x080039c8
    push {r4, lr}
    ldr r0, lbl_080039ec @ =unk_03001d00
    adds r0, #0x21
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_080039e6
...
lbl_080039e6:
    ...
    bx r0
    .align 2, 0
lbl_080039ec: .4byte unk_03001d00
...
sub_080039f4: @ 0x080039f4
    ...
    lsls r1, r1, #0x18
    lsrs r1, r1, #0x18
    ldr r3, lbl_08003a60 @ =unk_03001d00
    ldrb r0, [r3, #1]
    cmp r0, #0
    bne lbl_08003a58
    movs r0, #1
...
lbl_08003a3e:
    ...
    bl sub_08004b50
lbl_08003a52:
    ldr r1, lbl_08003a60 @ =unk_03001d00
    movs r0, #0
    strb r0, [r1, #1]
lbl_08003a58:
    pop {r4, r5, r6, r7}
    ...
    bx r0
    .align 2, 0
lbl_08003a60: .4byte unk_03001d00
...
sub_08003a6c: @ 0x08003a6c
    push {lr}
    ldr r0, lbl_08003a80 @ =unk_03001d00
    adds r0, #0x20
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_08003a88
    ...
    b lbl_08003a8c
    .align 2, 0
lbl_08003a80: .4byte unk_03001d00
...
fade_music: @ 0x08003a98
    ...
    lsls r0, r0, #0x10
    lsrs r2, r0, #0x10
    ldr r1, lbl_08003ac8 @ =unk_03001d00
    ldrb r0, [r1, #1]
    cmp r0, #0
    bne lbl_08003ada
    movs r0, #1
    ...
    b lbl_08003ad4
    .align 2, 0
lbl_08003ac8: .4byte unk_03001d00
lbl_08003acc: .4byte 0x0808f254
lbl_08003ad0:
    bl sub_08004c1c
lbl_08003ad4:
    ldr r1, lbl_08003ae0 @ =unk_03001d00
    movs r0, #0
    strb r0, [r1, #1]
lbl_08003ada:
    pop {r0}
    bx r0
    .align 2, 0
lbl_08003ae0: .4byte unk_03001d00
...
sub_08003ae4: @ 0x08003ae4
    ...
    lsls r0, r0, #0x10
    lsrs r2, r0, #0x10
    ldr r1, lbl_08003b14 @ =unk_03001d00
    ldrb r0, [r1, #1]
    cmp r0, #0
    bne lbl_08003b26
    movs r0, #1
    ...
    b lbl_08003b20
    .align 2, 0
lbl_08003b14: .4byte unk_03001d00
lbl_08003b18: .4byte 0x0808f254
lbl_08003b1c:
    bl sub_08004c1c
lbl_08003b20:
    ldr r1, lbl_08003b2c @ =unk_03001d00
    movs r0, #0
    strb r0, [r1, #1]
lbl_08003b26:
    pop {r0}
    bx r0
    .align 2, 0
lbl_08003b2c: .4byte unk_03001d00
...
sub_08003b30: @ 0x08003b30
    ...
    lsrs r2, r2, #0x18
    adds r5, r2, #0
    ldr r0, lbl_08003b60 @ =unk_03001d00
    adds r0, #0x21
    ldrb r1, [r0]
    movs r0, #0x84
    ands r0, r1
    ...
    b lbl_08003b72
    .align 2, 0
lbl_08003b60: .4byte unk_03001d00
lbl_08003b64:
...
sub_08003b7c: @ 0x08003b7c
    ...
    lsrs r2, r2, #0x18
    adds r6, r2, #0
    ldr r0, lbl_08003bac @ =unk_03001d00
    adds r0, #0x21
    ldrb r1, [r0]
    movs r0, #0x84
    ands r0, r1
    ...
    b lbl_08003bc6
    .align 2, 0
lbl_08003bac: .4byte unk_03001d00
lbl_08003bb0:
...
sub_08003bd0: @ 0x08003bd0
    ...
    lsls r1, r1, #0x10
    lsrs r4, r1, #0x10
    ldr r0, lbl_08003c14 @ =unk_03001d00
    adds r0, #0x21
    ldrb r1, [r0]
    movs r0, #0x84
    ands r0, r1
...
lbl_08003c0c:
    ...
    bx r0
    .align 2, 0
lbl_08003c14: .4byte unk_03001d00
...
sub_08003c20: @ 0x08003c20
    ...
    lsls r2, r2, #0x18
    lsrs r2, r2, #0x18
    ldr r3, lbl_08003c94 @ =unk_03001d00
    ldrb r0, [r3, #1]
    cmp r0, #0
    bne lbl_08003c8c
    movs r0, #1
...
lbl_08003c70:
    ...
    bl sub_08002dfc
lbl_08003c86:
    ldr r1, lbl_08003c94 @ =unk_03001d00
    movs r0, #0
    strb r0, [r1, #1]
lbl_08003c8c:
    pop {r4, r5, r6, r7}
    ...
    bx r0
    .align 2, 0
lbl_08003c94: .4byte unk_03001d00
...
sub_08003ca0: @ 0x08003ca0
    ...
    lsrs r3, r1, #0x18
    adds r6, r3, #0
    ldr r1, lbl_08003d00 @ =unk_03001d00
    ldrb r0, [r1, #1]
    cmp r0, #0
    bne lbl_08003d40
    movs r7, #0
...
lbl_08003ce4:
    ...
    b lbl_08003d1e
    .align 2, 0
lbl_08003d00: .4byte unk_03001d00
...
lbl_08003d1e:
    ...
    strb r0, [r2]
lbl_08003d24:
    ldr r3, lbl_08003d48 @ =unk_03001d00
    adds r1, r3, #0
    adds r1, #0x20
    movs r2, #0
    movs r0, #1
    ...
    bl sub_08004b50
lbl_08003d3a:
    ldr r1, lbl_08003d48 @ =unk_03001d00
    movs r0, #0
    strb r0, [r1, #1]
lbl_08003d40:
    pop {r4, r5, r6, r7}
    ...
    bx r0
    .align 2, 0
lbl_08003d48: .4byte unk_03001d00
...
sub_08003d4c: @ 0x08003d4c
    ...
    lsrs r0, r0, #0x18
    mov r8, r0
    ldr r4, lbl_08003d98 @ =unk_03001d00
    ldrb r5, [r4, #1]
    cmp r5, #0
    bne lbl_08003e02
    movs r0, #1
...
lbl_08003d76:
    ...
    b lbl_08003da2
    .align 2, 0
lbl_08003d98: .4byte unk_03001d00
...
lbl_08003da2:
    ...
    adds r0, r0, r1
    ldr r1, [r0]
    ldr r7, lbl_08003e14 @ =unk_03001d00
    movs r0, #0
    mov sb, r0
    mov r0, sb
    strb r0, [r7, #1]
...
lbl_08003e14: .4byte unk_03001d00
...
sub_08003e24: @ 0x08003e24
    ...
    lsls r0, r0, #0x10
    lsrs r1, r0, #0x10
    ldr r0, lbl_08003e3c @ =unk_03001d00
    adds r0, #0x20
    ldrb r0, [r0]
    cmp r0, #0
    bne lbl_08003e44
    ...
    b lbl_08003e48
    .align 2, 0
lbl_08003e3c: .4byte unk_03001d00
...
lbl_08003e64:
    lsrs r2, r0, #0x18
    adds r4, r2, #0
    ldr r1, lbl_08003e88 @ =unk_03001d00
    ldrb r0, [r1, #1]
    adds r3, r1, #0
    cmp r0, #0
    bne lbl_08003eb0
    ...
    b lbl_08003eac
    .align 2, 0
lbl_08003e88: .4byte unk_03001d00
lbl_08003e8c:
    cmp r2, #0xff
    bne lbl_08003e9e
    adds r2, r3, #0
...
sub_08003eb8: @ 0x08003eb8
    push {r4, r5, r6, lr}
    ldr r1, lbl_08003ef0 @ =unk_03001d00
    ldrb r2, [r1, #1]
    cmp r2, #0
    bne lbl_08003f12
    movs r0, #1
    ...
    b lbl_08003f02
    .align 2, 0
lbl_08003ef0: .4byte unk_03001d00
...
lbl_08003f02:
    ldr r1, [r0]
    ldr r5, lbl_08003f1c @ =unk_03001d00
    movs r4, #0
    strb r4, [r5, #1]
    adds r0, r6, #0
    bl sub_08004b50
...
lbl_08003f1c: .4byte unk_03001d00
...
sub_08003f20: @ 0x08003f20
    ...
    movs r0, #0
    bl sub_080034ac
    ldr r2, lbl_08003f5c @ =unk_03001d00
    ldrb r1, [r2, #0xb]
    movs r0, #0x80
    orrs r0, r1
    strb r0, [r2, #0xb]
    ...
    bx r0
    .align 2, 0
lbl_08003f5c: .4byte unk_03001d00
...
sub_08003f6c: @ 0x08003f6c
    ...
    adds r2, r6, #0
    bl sub_08003058
    ldr r2, lbl_08003fa8 @ =unk_03001d00
    ldrb r1, [r2, #0xb]
    movs r0, #0x7f
    ands r0, r1
    strb r0, [r2, #0xb]
...
lbl_08003fa8: .4byte unk_03001d00
...
sub_08004228: @ 0x08004228
    ...
    lsls r0, r0, #0x10
    lsrs r5, r0, #0x10
    ldr r0, lbl_08004258 @ =unk_03001d00
    ldrh r0, [r0, #0x1c]
    cmp r5, r0
    beq lbl_08004250
...
lbl_08004250:
    ...
    bx r0
    .align 2, 0
lbl_08004258: .4byte unk_03001d00
...
sub_080042bc: @ 0x080042bc
    ...
    lsls r0, r0, #0x10
    lsrs r5, r0, #0x10
    ldr r4, lbl_08004300 @ =unk_03001d00
    ldrb r6, [r4, #1]
    cmp r6, #0
    bne lbl_080042f8
    movs r0, #1
...
lbl_080042f8:
    ...
    bx r0
    .align 2, 0
lbl_08004300: .4byte unk_03001d00
...
sub_08004adc: @ 0x08004adc
    ldr r0, lbl_08004b44 @ =unk_03001d00
    ldrb r1, [r0, #0x10]
    add r1, r1, #1
    ldrb r3, [r0, #0xe]
    cmp r1, r3
...
sub_08004b3c: @ 0x08004b3c
    ...
    bx lr
    .align 2, 0
lbl_08004b44: .4byte unk_03001d00
...
lbl_08004d72:
    ...
    ldr r6, lbl_08004e04 @ =unk_03001d00
    movs r0, #0x21
    ldrb r0, [r6, r0]
    movs r1, #0x80
    ands r1, r0
...
lbl_08004e04: .4byte unk_03001d00
...
lbl_0800500a:
    ldrb r2, [r5, #0x18]
    bl midikey2freq
    ldr r1, lbl_0800502c @ =unk_03001d00
    ldrh r2, [r1, #0x12]
    cmp r0, r2
    bne lbl_0800501e
    movs r0, #0x40
...
lbl_08005024:
    ...
    bx r0
    .align 2, 0
lbl_0800502c: .4byte unk_03001d00

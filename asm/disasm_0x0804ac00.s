...
sub_0804ac00: @ 0x0804ac00
    ...
    lsls r0, r0, #0x18
    lsrs r4, r0, #0x18
    ldr r2, lbl_0804ac40 @ =gCurrentSprite
    adds r1, r2, #0
    adds r1, #0x2e
    ldrb r0, [r1]
    subs r0, #1
...
lbl_0804ac34:
    ...
    b lbl_0804ac58
    .align 2, 0
lbl_0804ac40: .4byte gCurrentSprite
lbl_0804ac44:
    cmp r1, #1
    bhi lbl_0804ac4c
    adds r0, r1, #1
...
EscapeShipSetIgnoreSamus: @ 0x0804ac94
    push {r4, r5, lr}
    ldr r2, lbl_0804acc4 @ =gSpriteData
    movs r1, #0xa8
    lsls r1, r1, #3
    adds r0, r2, r1
    cmp r2, r0
...
lbl_0804acfc:
    ...
    bx r0
    .align 2, 0
lbl_0804ad04: .4byte gSpriteData
...
EscapeShipPirateCollision: @ 0x0804ad08
    ...
    push {r5, r6, r7}
    sub sp, #0x10
    ldr r2, lbl_0804ada4 @ =gCurrentSprite
    ldrh r1, [r2, #2]
    ldrh r3, [r2, #4]
    ldrh r0, [r2, #0xa]
    adds r0, r1, r0
    ...
    lsls r3, r3, #0x10
    lsrs r7, r3, #0x10
    ldr r6, lbl_0804ada8 @ =gSpriteData
    movs r1, #0xa8
    lsls r1, r1, #3
    adds r0, r6, r1
    cmp r6, r0
...
lbl_0804ad50:
    ...
    b lbl_0804adb6
    .align 2, 0
lbl_0804ada4: .4byte gCurrentSprite
lbl_0804ada8: .4byte gSpriteData
lbl_0804adac:
    adds r5, #0x38
    adds r6, #0x38
    ldr r0, lbl_0804adc8 @ =gSpritesetSpritesID
    cmp r6, r0
    blo lbl_0804ad50
lbl_0804adb6:
    add sp, #0x10
    ...
    bx r0
    .align 2, 0
lbl_0804adc8: .4byte gSpritesetSpritesID
...
EscapeShipCheckCollidingWithLaser: @ 0x0804adcc
    ...
    push {r5, r6, r7}
    sub sp, #0x14
    ldr r2, lbl_0804ae6c @ =gCurrentSprite
    ldrh r1, [r2, #2]
    ldrh r3, [r2, #4]
    ldrh r0, [r2, #0xa]
    adds r0, r1, r0
    ...
    mov r8, r3
    movs r7, #4
    ldr r6, lbl_0804ae70 @ =gSpriteData
    movs r1, #0xa8
    lsls r1, r1, #3
    adds r0, r6, r1
    cmp r6, r0
...
lbl_0804ae14:
    ...
    b lbl_0804ae7c
    .align 2, 0
lbl_0804ae6c: .4byte gCurrentSprite
lbl_0804ae70: .4byte gSpriteData
lbl_0804ae74:
    adds r6, #0x38
    ldr r0, lbl_0804ae8c @ =gSpritesetSpritesID
    cmp r6, r0
    blo lbl_0804ae14
lbl_0804ae7c:
    add sp, #0x14
    ...
    bx r0
    .align 2, 0
lbl_0804ae8c: .4byte gSpritesetSpritesID
...
EscapeShip: @ 0x0804ae90
    ...
    push {r7}
    sub sp, #0xc
    ldr r0, lbl_0804aeb8 @ =gCurrentSprite
    ldrh r1, [r0, #2]
    mov r8, r1
    ldrh r7, [r0, #4]
    adds r1, r0, #0
...
lbl_0804aeae:
    ...
    mov pc, r0
    .align 2, 0
lbl_0804aeb8: .4byte gCurrentSprite
...
lbl_0804af60:
    ldr r5, lbl_0804afd4 @ =gCurrentSprite
    adds r1, r5, #0
    adds r1, #0x27
    movs r4, #0
    movs r0, #0x30
    ...
    movs r0, #8
    strb r0, [r1]
    ldr r0, lbl_0804afe0 @ =gSubSpriteData1
    strb r2, [r0, #0xf]
    ldrb r2, [r5, #0x1f]
    adds r6, r5, #0
    adds r6, #0x23
    ...
    b lbl_0804b33e
    .align 2, 0
lbl_0804afd4: .4byte gCurrentSprite
lbl_0804afd8: .4byte 0x0000ffd4
lbl_0804afdc: .4byte 0x0831c370
lbl_0804afe0: .4byte gSubSpriteData1
lbl_0804afe4:
    movs r0, #3
    movs r1, #0x4a
    bl EventFunction
    ...
    b lbl_0804b33e
lbl_0804aff2:
    ldr r2, lbl_0804b050 @ =gSamusData
    ldrh r0, [r2, #0x14]
    cmp r0, r8
    bls lbl_0804affc
    b lbl_0804b33e
...
lbl_0804b012:
    ...
    b lbl_0804b33e
lbl_0804b01a:
    ldr r2, lbl_0804b054 @ =gCurrentSprite
    adds r1, r2, #0
    adds r1, #0x24
    movs r4, #0
    movs r0, #9
    ...
    b lbl_0804b33e
    .align 2, 0
lbl_0804b050: .4byte gSamusData
lbl_0804b054: .4byte gCurrentSprite
lbl_0804b058: .4byte 0x0831c380
lbl_0804b05c: .4byte 0x0000024e
lbl_0804b060:
    ldr r2, lbl_0804b07c @ =gCurrentSprite
    ldrh r0, [r2, #0x16]
    cmp r0, #6
    bhi lbl_0804b06a
    b lbl_0804b33e
lbl_0804b06a:
    ...
    b lbl_0804b33e
    .align 2, 0
lbl_0804b07c: .4byte gCurrentSprite
lbl_0804b080:
    ldr r2, lbl_0804b0d4 @ =gCurrentSprite
    ldrh r3, [r2]
    movs r0, #0x80
    lsls r0, r0, #5
    ands r0, r3
...
lbl_0804b090:
    ...
    adds r0, #0x25
    strb r3, [r0]
    ldr r1, lbl_0804b0dc @ =gSamusData
    ldrb r0, [r1, #6]
    cmp r0, #0
    beq lbl_0804b0c2
    strb r3, [r1, #6]
lbl_0804b0c2:
    ...
    b lbl_0804b0e6
    .align 2, 0
lbl_0804b0d4: .4byte gCurrentSprite
lbl_0804b0d8: .4byte 0x0000efff
lbl_0804b0dc: .4byte gSamusData
lbl_0804b0e0:
    movs r0, #0x42
    bl SamusSetPose
lbl_0804b0e6:
    ...
    movs r1, #0x4b
    bl EventFunction
    ldr r1, lbl_0804b104 @ =gCurrentSprite
    movs r2, #0
    ...
    b lbl_0804b33e
    .align 2, 0
lbl_0804b104: .4byte gCurrentSprite
lbl_0804b108: .4byte 0x0000ff60
lbl_0804b10c:
    ldr r2, lbl_0804b13c @ =gCurrentSprite
    adds r1, r2, #0
    adds r1, #0x2c
    ldrb r0, [r1]
    subs r0, #1
...
lbl_0804b122:
    ...
    b lbl_0804b33e
    .align 2, 0
lbl_0804b13c: .4byte gCurrentSprite
...
lbl_0804b148:
    ...
    b lbl_0804b33e
lbl_0804b152:
    ldr r3, lbl_0804b188 @ =gCurrentSprite
    ...
    adds r0, #1
    strb r2, [r0]
    ldr r1, lbl_0804b190 @ =gSubSpriteData1
    movs r0, #1
    strb r0, [r1, #0xf]
    b lbl_0804b33e
    .align 2, 0
lbl_0804b188: .4byte gCurrentSprite
lbl_0804b18c: .4byte 0x0831c370
lbl_0804b190: .4byte gSubSpriteData1
lbl_0804b194:
    adds r3, r5, #0
    adds r4, r3, #0
    adds r4, #0x2c
...
lbl_0804b218:
    ...
    b lbl_0804b2a2
lbl_0804b224:
    ldr r2, lbl_0804b250 @ =gCurrentSprite
    adds r3, r2, #0
    adds r3, #0x2c
    ldrb r0, [r3]
    cmp r0, #0
    ...
    b lbl_0804b26a
    .align 2, 0
lbl_0804b250: .4byte gCurrentSprite
...
lbl_0804b25c:
    ...
    cmp r0, #0x64
    bne lbl_0804b26a
    ldr r1, lbl_0804b274 @ =gSubSpriteData1
    movs r0, #2
    strb r0, [r1, #0xf]
lbl_0804b26a:
    ldr r1, lbl_0804b278 @ =gCurrentSprite
    ldrh r0, [r1, #2]
    subs r0, #2
    strh r0, [r1, #2]
    b lbl_0804b2a2
    .align 2, 0
lbl_0804b274: .4byte gSubSpriteData1
lbl_0804b278: .4byte gCurrentSprite
lbl_0804b27c:
    adds r3, r2, #0
    adds r3, #0x2d
    ldrb r0, [r3]
    ...
    bl SoundPlay
lbl_0804b2a2:
    ldr r3, lbl_0804b2fc @ =gCurrentSprite
    adds r5, r3, #0
    adds r5, #0x2f
    ldrb r2, [r5]
...
lbl_0804b31c:
    ...
    bl StartEffectForCutscene
lbl_0804b33e:
    ldr r5, lbl_0804b384 @ =gCurrentSprite
    adds r4, r5, #0
    adds r4, #0x24
    ldrb r0, [r4]
    cmp r0, #0x22
    bls lbl_0804b378
    ldr r1, lbl_0804b388 @ =gSamusData
    mov r0, r8
    subs r0, #0x2b
    strh r0, [r1, #0x14]
    adds r0, r7, #0
...
lbl_0804b378:
    ...
    bx r0
    .align 2, 0
lbl_0804b384: .4byte gCurrentSprite
lbl_0804b388: .4byte gSamusData

    thumb_func_start EscapeShipPart
EscapeShipPart: @ 0x0804b38c
    push {r4, r5, lr}
    ldr r3, lbl_0804b3c0 @ =gCurrentSprite
    adds r0, r3, #0
    adds r0, #0x23
    ldrb r4, [r0]
    ldr r2, lbl_0804b3c4 @ =gSpriteData
    lsls r0, r4, #3
    subs r0, r0, r4
    lsls r0, r0, #3
    adds r0, r0, r2
...
lbl_0804b3b4:
    ...
    mov pc, r0
    .align 2, 0
lbl_0804b3c0: .4byte gCurrentSprite
lbl_0804b3c4: .4byte gSpriteData

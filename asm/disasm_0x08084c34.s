...
vblank_during_chozodia_escape: @ 0x0808784c
    ...
    ldr r0, [r1, #8]
    subs r1, #0xd4
    ldr r0, lbl_080878ec @ =sNonGameplayRamPointer
    ldr r4, [r0]
    movs r2, #0xdc
    lsls r2, r2, #2
    adds r0, r4, r2
...
lbl_080878ec: .4byte sNonGameplayRamPointer
...
sub_08087938: @ 0x08087938
    ...
    ldr r0, lbl_0808796c @ =sNonGameplayRamPointer
    ldr r2, [r0]
    lsls r3, r3, #1
...
lbl_0808796c: .4byte sNonGameplayRamPointer
...
sub_08087974: @ 0x08087974
    ...
    str r0, [r2]
    ldr r0, lbl_080879a0 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    adds r1, r0, #0
    adds r1, #0x6c
    str r1, [r2, #4]
...
lbl_080879a0: .4byte sNonGameplayRamPointer
...
sub_080879a8: @ 0x080879a8
    ...
    movs r0, #0x1f
    strh r0, [r1]
    ldr r0, lbl_080879f8 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    movs r0, #0xdc
    lsls r0, r0, #2
    adds r2, r2, r0
...
lbl_080879f8: .4byte sNonGameplayRamPointer
...
sub_08087a0c: @ 0x08087a0c
    ...
    mov r6, r8
    push {r6, r7}
    ldr r2, lbl_08087a38 @ =sNonGameplayRamPointer
    ldr r0, [r2]
    movs r1, #0xdb
    lsls r1, r1, #2
    adds r0, r0, r1
    ...
    b lbl_08087a54
    .align 2, 0
lbl_08087a38: .4byte sNonGameplayRamPointer
...
chozodia_escape_process_oam: @ 0x08087c08
    ...
    movs r7, #0
lbl_08087c1e:
    ldr r1, lbl_08087c74 @ =sNonGameplayRamPointer
    ldr r2, [r1]
    adds r0, r2, #6
    adds r0, r0, r7
    ldrb r0, [r0]
...
lbl_08087c74: .4byte sNonGameplayRamPointer
lbl_08087c78:
    ldrh r1, [r4]
    adds r4, #2
    strh r1, [r5]
    ...
    cmp r7, #4
    bne lbl_08087c78
    ldr r1, lbl_08087cf4 @ =sNonGameplayRamPointer
    ldr r0, [r1]
lbl_08087cc0:
    adds r0, #0x24
    ldrb r0, [r0]
...
lbl_08087cf4: .4byte sNonGameplayRamPointer
...
chozodia_escape_process_oam2: @ 0x08087cfc
    ...
    mov r8, r0
    movs r6, #0
    ldr r0, lbl_08087e3c @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrb r0, [r1, #6]
    cmp r0, #0
    beq lbl_08087d8e
...
lbl_08087e3c: .4byte sNonGameplayRamPointer
...
chozodia_escape_init: @ 0x08087e4c
    ...
    strb r5, [r0]
    ldr r4, lbl_080880d4 @ =sNonGameplayRamPointer
    ldr r1, [r4]
...
lbl_080880d4: .4byte sNonGameplayRamPointer
...
lbl_08088108:
    strb r0, [r1]
    ldr r0, lbl_08088144 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    movs r3, #0xdc
    lsls r3, r3, #2
    adds r2, r1, r3
...
lbl_08088144: .4byte sNonGameplayRamPointer
...
chozodia_escape_escape_ship_leaving: @ 0x08088158
    push {r4, r5, r6, lr}
    movs r6, #0
    ldr r3, lbl_08088178 @ =sNonGameplayRamPointer
    ldr r2, [r3]
    ldrh r0, [r2, #4]
    adds r1, r0, #1
    strh r1, [r2, #4]
    ...
    b lbl_080881d6
    .align 2, 0
lbl_08088178: .4byte sNonGameplayRamPointer
lbl_0808817c:
    movs r0, #0x93
    lsls r0, r0, #1
    cmp r1, r0
...
lbl_080881d4:
    movs r6, #1
lbl_080881d6:
    ldr r0, lbl_08088200 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    ldrb r3, [r2, #6]
    adds r5, r0, #0
    cmp r3, #1
    ...
    b lbl_0808820c
    .align 2, 0
lbl_08088200: .4byte sNonGameplayRamPointer
lbl_08088204:
    cmp r1, #0x38
    bls lbl_0808821c
    ldrh r1, [r2, #4]
...
chozodia_escape_mother_ship_heating_up: @ 0x080882dc
    push {r4, r5, lr}
    movs r5, #0
    ldr r3, lbl_080882fc @ =sNonGameplayRamPointer
    ldr r2, [r3]
    ldrh r0, [r2, #4]
    adds r1, r0, #1
    strh r1, [r2, #4]
    ...
    b lbl_08088378
    .align 2, 0
lbl_080882fc: .4byte sNonGameplayRamPointer
lbl_08088300:
    cmp r0, #0xa0
    beq lbl_08088334
    cmp r0, #0xe0
...
lbl_08088378:
    bl sub_08087a0c
    ldr r3, lbl_08088444 @ =sNonGameplayRamPointer
    ldr r2, [r3]
    ldrb r0, [r2, #1]
    cmp r0, #0
    beq lbl_080883c2
...
lbl_080883a0:
    ...
    strb r0, [r1, #2]
lbl_080883a6:
    ldr r0, lbl_08088444 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    movs r2, #0xdb
    lsls r2, r2, #2
    adds r1, r0, r2
    ...
    strh r0, [r1]
lbl_080883c2:
    ldr r4, lbl_08088444 @ =sNonGameplayRamPointer
    ldr r0, [r4]
    ldrh r0, [r0, #4]
    lsls r1, r0, #0x10
    lsrs r0, r1, #0x10
...
lbl_08088444: .4byte sNonGameplayRamPointer
...
chozodia_escape_mother_ship_blowing_up: @ 0x08088508
    ...
    movs r0, #0
    str r0, [sp]
    ldr r4, lbl_08088540 @ =sNonGameplayRamPointer
    ldr r2, [r4]
    ldrh r0, [r2, #4]
    adds r1, r0, #1
    strh r1, [r2, #4]
...
lbl_0808852c:
    ...
    b lbl_0808870a
    .align 2, 0
lbl_08088540: .4byte sNonGameplayRamPointer
lbl_08088544:
    cmp r1, #2
    beq lbl_080885a0
    cmp r1, #3
...
lbl_08088706:
    ...
    str r2, [sp]
lbl_0808870a:
    ldr r0, lbl_080887c8 @ =sNonGameplayRamPointer
    ldr r3, [r0]
    ldrb r1, [r3, #1]
    adds r5, r0, #0
    cmp r1, #1
...
lbl_080887b4:
    ...
    b lbl_080887f2
    .align 2, 0
lbl_080887c8: .4byte sNonGameplayRamPointer
...
chozodia_escape_escape_ship_leaving_planet: @ 0x080888f4
    push {r4, r5, lr}
    movs r5, #0
    ldr r4, lbl_0808891c @ =sNonGameplayRamPointer
    ldr r2, [r4]
    ldrh r0, [r2, #4]
    adds r1, r0, #1
    strh r1, [r2, #4]
    ...
    b lbl_08088aae
    .align 2, 0
lbl_0808891c: .4byte sNonGameplayRamPointer
lbl_08088920:
    movs r0, #0x80
    lsls r0, r0, #1
    cmp r1, r0
...
lbl_08088aa0:
    ...
    movs r5, #1
lbl_08088aae:
    ldr r0, lbl_08088ad4 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    ldrb r3, [r2, #1]
    adds r4, r0, #0
    cmp r3, #0
    ...
    b lbl_08088ae0
    .align 2, 0
lbl_08088ad4: .4byte sNonGameplayRamPointer
...
lbl_08088b16:
    ...
    strb r3, [r1]
lbl_08088b28:
    ldr r0, lbl_08088b58 @ =sNonGameplayRamPointer
    ldr r2, [r0]
    adds r0, r2, #0
    adds r0, #0x44
    ldrh r1, [r0]
    ...
    b lbl_08088bce
    .align 2, 0
lbl_08088b58: .4byte sNonGameplayRamPointer
lbl_08088b5c:
    cmp r0, #2
    bne lbl_08088bce
    adds r1, #0x25
...
lbl_08088bca:
    bl chozodia_escape_process_oam2
lbl_08088bce:
    ldr r0, lbl_08088bf4 @ =sNonGameplayRamPointer
    ldr r0, [r0]
    ldrh r1, [r0, #4]
    movs r0, #0xf
    ands r0, r1
...
lbl_08088bec:
    ...
    bx r1
    .align 2, 0
lbl_08088bf4: .4byte sNonGameplayRamPointer
...
chozodia_escape_mission_accomplished: @ 0x08088c00
    ...
    sub sp, #4
    movs r5, #0
    ldr r4, lbl_08088c24 @ =sNonGameplayRamPointer
    ldr r2, [r4]
    ldrh r0, [r2, #4]
    adds r1, r0, #1
    strh r1, [r2, #4]
    ...
    b lbl_08088cee
    .align 2, 0
lbl_08088c24: .4byte sNonGameplayRamPointer
lbl_08088c28:
    cmp r1, #0x40
    beq lbl_08088c9a
    movs r0, #0xec
...
lbl_08088cc0:
    str r0, [r1, #0x1c]
    ldr r2, lbl_08088cdc @ =sNonGameplayRamPointer
    ldr r0, [r2]
    adds r0, #0x24
    movs r1, #1
    strb r1, [r0]
...
lbl_08088cdc: .4byte sNonGameplayRamPointer
lbl_08088ce0:
    ...
    movs r5, #2
lbl_08088cee:
    ldr r3, lbl_08088d54 @ =sNonGameplayRamPointer
    ldr r1, [r3]
    ldrb r0, [r1, #0xa]
    cmp r0, #0
    beq lbl_08088d22
...
lbl_08088d22:
    bl chozodia_escape_process_oam
    ldr r0, lbl_08088d54 @ =sNonGameplayRamPointer
    ldr r1, [r0]
    ldrb r0, [r1, #1]
    cmp r0, #0
    bne lbl_08088d42
...
lbl_08088d54: .4byte sNonGameplayRamPointer
...
lbl_08088da4:
    ldr r0, lbl_08088db8 @ =sNonGameplayRamPointer
    ldr r0, [r0]
...
lbl_08088dae:
    ...
    b lbl_08088e96
    .align 2, 0
lbl_08088db8: .4byte sNonGameplayRamPointer
lbl_08088dbc: .4byte 0x00000372
lbl_08088dc0:
    ldr r1, lbl_08088e58 @ =0x08760d14
    ldr r4, lbl_08088e5c @ =sNonGameplayRamPointer
    ldr r0, [r4]
    ldrb r0, [r0]
    lsls r0, r0, #2
    adds r0, r0, r1
...
lbl_08088e5c: .4byte sNonGameplayRamPointer
